...
| `../../sm83/Icarus/` | **SM83 core suite** (issue #400): register file, ALU+flags, memory, stack, jumps, IRQ, HALT modes, CB-prefix rotate/bit ops, instruction timing - real core netlist, waves.md, STATUS.md |
