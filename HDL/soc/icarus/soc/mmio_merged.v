module MMIO (  reset, clk2, clk4, osc_stable, clk_ena, osc_ena, clk6, clk9, n_reset2, cpu_wr_sync, cpu_m1, n_cpu_m1, 
	...
	dmg_bufif0 g91 (.a0(w50), .n_ena(w8), .a1(w50), .x(a[12]) );
	dmg_bufif0 g92 (.a0(w5), .n_ena(w8), .a1(w5), .x(a[13]) );
	dmg_bufif0 g93 (.a0(w232), .n_ena(w8), .a1(w232), .x(a[8]) );
	dmg_bufif0 g94 (.a0(w9), .n_ena(w8), .a1(w9), .x(a[11]) );
	dmg_bufif0 g95 (.a0(w11), .n_ena(w8), .a1(w11), .x(a[9]) );
	dmg_bufif0 g96 (.a0(w264), .n_ena(w8), .a1(w264), .x(a[14]) );
	dmg_latch g97 (.ena(w129), .d(a[12]), .q(w207) );
	dmg_latch g98 (.ena(w129), .d(a[11]), .q(w206) );
	dmg_latch g99 (.ena(w129), .d(a[8]), .q(w236) );
	dmg_latch g100 (.ena(w129), .d(a[13]), .q(w3) );
	dmg_latch g101 (.ena(w129), .d(a[9]), .q(w226) );
	dmg_latch g102 (.ena(w149), .d(w130), .nq(w152) );
	dmg_latch g103 (.ena(w149), .d(w160), .nq(w163) );
	dmg_latch g104 (.ena(w129), .d(a[14]), .q(w27) );
	dmg_latch g105 (.ena(w149), .d(w150), .nq(w351) );
	dmg_latch g106 (.ena(w149), .d(w162), .nq(w316) );
	dmg_latch g107 (.ena(w129), .d(a[10]), .q(w337) );
	dmg_latch g108 (.ena(w149), .d(w151), .nq(w324) );
	dmg_bufif0 g109 (.a0(w210), .n_ena(w8), .a1(w210), .x(a[10]) );
	dmg_dffr g110 (.clk(w74), .nr1(w12), .d(w14), .nr2(w12), .nq(w13) );
	dmg_dffr g111 (.clk(w223), .nr1(w63), .d(d[1]), .nr2(w63), .nq(w336), .q(w335) );
	...
	dmg_dffr g124 (.clk(w223), .nr1(w63), .d(d[4]), .nr2(w63), .nq(w96), .q(w95) );
	dmg_dffr g125 (.clk(w221), .nr1(w61), .d(w62), .nr2(w61), .nq(w62), .q(w140) );
	dmg_dffr g126 (.clk(w223), .nr1(w63), .d(d[3]), .nr2(w63), .nq(w329), .q(w222) );
	...
	dmg_dffr g134 (.clk(w148), .nr1(w63), .d(d[2]), .nr2(w63), .nq(w126) );
	dmg_dffr g135 (.clk(w148), .nr1(w63), .d(d[0]), .nr2(w63), .nq(w345), .q(w82) );
	dmg_dffr g136 (.clk(w148), .nr1(w63), .d(d[1]), .nr2(w63), .nq(w251), .q(w250) );
	dmg_dffr g137 (.clk(w114), .nr1(w61), .d(w224), .nr2(w61), .nq(w224), .q(w136) );
	dmg_dffr g138 (.clk(w224), .nr1(w61), .d(w221), .nr2(w61), .nq(w221), .q(w115) );
	dmg_dffr g139 (.clk(w223), .nr1(w63), .d(d[7]), .nr2(w63), .nq(w301), .q(w361) );
	dmg_dffr g140 (.clk(w223), .nr1(w63), .d(d[0]), .nr2(w63), .nq(w220), .q(w334) );
	dmg_dffr g141 (.clk(w223), .nr1(w63), .d(d[5]), .nr2(w63), .nq(w97), .q(w98) );
	dmg_dffr g142 (.clk(w223), .nr1(w63), .d(d[6]), .nr2(w63), .nq(w118), .q(w119) );
	...
	dmg_dffr g150 (.clk(w223), .nr1(w63), .d(d[2]), .nr2(w63), .nq(w295), .q(w296) );
	...
	dmg_latchnq_comp g157 (.n_ena(w241), .d(d[4]), .ena(w154), .q(w156), .nq(w155) );
	dmg_latchnq_comp g158 (.n_ena(w241), .d(d[3]), .ena(w154), .q(w205), .nq(w353) );
	dmg_latchnq_comp g159 (.n_ena(w241), .d(d[0]), .ena(w154), .q(w237), .nq(w347) );
	dmg_latchnq_comp g160 (.n_ena(w241), .d(d[6]), .ena(w154), .q(w325), .nq(w346) );
	dmg_latchnq_comp g161 (.n_ena(w241), .d(d[5]), .ena(w154), .q(w209), .nq(w252) );
	dmg_latchnq_comp g162 (.n_ena(w241), .d(d[1]), .ena(w154), .q(w274), .nq(w128) );
	dmg_latchnq_comp g163 (.n_ena(w241), .d(d[2]), .ena(w154), .q(w280), .nq(w305) );
	dmg_latchnq_comp g164 (.n_ena(w241), .d(d[7]), .ena(w154), .q(w190), .nq(w242) );
	...
	dmg_muxi g177 (.sel(w99), .d1(w296), .d0(d[2]), .q(w230) );
	dmg_muxi g178 (.sel(w99), .d1(w361), .d0(d[7]), .q(w120) );
	dmg_muxi g179 (.sel(w99), .d1(w119), .d0(d[6]), .q(w121) );
	dmg_muxi g180 (.sel(w99), .d1(w334), .d0(d[0]), .q(w30) );
	...
	dmg_muxi g186 (.sel(w99), .d1(w98), .d0(d[5]), .q(w18) );
	dmg_muxi g187 (.sel(w99), .d1(w222), .d0(d[3]), .q(w90) );
	dmg_muxi g188 (.sel(w99), .d1(w95), .d0(d[4]), .q(w333) );
	dmg_muxi g189 (.sel(w99), .d1(w335), .d0(d[1]), .q(w354) );
	...
	dmg_not g200 (.a(a[1]), .x(w108) );
	dmg_not g201 (.a(a[0]), .x(w110) );
	dmg_not3 g202 (.a(w157), .x(w109) );
	dmg_not3 g203 (.a(w46), .x(w45) );
	dmg_and3 g204 (.a(w135), .b(w70), .c(w63), .x(w134) );
	dmg_and4 g205 (.a(w100), .b(w45), .c(w108), .d(a[0]), .x(w33) );
	dmg_and4 g206 (.a(w100), .b(w45), .c(a[1]), .d(w110), .x(w89) );
	...
	dmg_and4 g211 (.a(w146), .b(w45), .c(a[1]), .d(w110), .x(w145) );
	dmg_and4 g212 (.a(w146), .b(w45), .c(w108), .d(a[0]), .x(w144) );
	dmg_notif1 g213 (.ena(w138), .a(w105), .x(d[0]) );
	dmg_notif1 g214 (.ena(w138), .a(w311), .x(d[2]) );
	dmg_notif1 g215 (.ena(w138), .a(w343), .x(d[3]) );
	dmg_notif1 g216 (.ena(w138), .a(w77), .x(d[1]) );
	dmg_notif1 g217 (.ena(w138), .a(w139), .x(d[7]) );
	dmg_notif1 g218 (.ena(w33), .a(w72), .x(d[2]) );
	dmg_notif1 g219 (.ena(w33), .a(w294), .x(d[1]) );
	dmg_notif1 g220 (.ena(w33), .a(w229), .x(d[6]) );
	dmg_notif1 g221 (.ena(w89), .a(w118), .x(d[6]) );
	dmg_notif1 g222 (.ena(w317), .a(w324), .x(d[2]) );
	dmg_notif1 g223 (.ena(w306), .a(w346), .x(d[6]) );
	dmg_notif1 g224 (.ena(w306), .a(w252), .x(d[5]) );
	dmg_notif1 g225 (.ena(w127), .a(w251), .x(d[1]) );
	dmg_notif1 g226 (.ena(w306), .a(w128), .x(d[1]) );
	dmg_notif1 g227 (.ena(w127), .a(w345), .x(d[0]) );
	dmg_notif1 g228 (.ena(w344), .a(w20), .x(d[7]) );
	dmg_notif1 g229 (.ena(w344), .a(w20), .x(d[5]) );
	dmg_notif1 g230 (.ena(w344), .a(w20), .x(d[6]) );
	dmg_notif1 g231 (.ena(w344), .a(w20), .x(d[1]) );
	dmg_notif1 g232 (.ena(w344), .a(w20), .x(d[3]) );
	dmg_notif1 g233 (.ena(w344), .a(w20), .x(d[2]) );
	dmg_notif1 g234 (.ena(w100), .a(w20), .x(d[4]) );
	dmg_notif1 g235 (.ena(w100), .a(w20), .x(d[0]) );
	dmg_notif1 g236 (.ena(w306), .a(w305), .x(d[2]) );
	dmg_notif1 g237 (.ena(w306), .a(w242), .x(d[7]) );
	dmg_notif1 g238 (.ena(w317), .a(w316), .x(d[0]) );
	dmg_notif1 g239 (.ena(w317), .a(w351), .x(d[1]) );
	dmg_notif1 g240 (.ena(w89), .a(w295), .x(d[2]) );
	dmg_notif1 g241 (.ena(w33), .a(w122), .x(d[7]) );
	dmg_notif1 g242 (.ena(w89), .a(w336), .x(d[1]) );
	dmg_notif1 g243 (.ena(w317), .a(w163), .x(d[3]) );
	dmg_notif1 g244 (.ena(w317), .a(w152), .x(d[4]) );
	dmg_notif1 g245 (.ena(w306), .a(w347), .x(d[0]) );
	dmg_notif1 g246 (.ena(w306), .a(w353), .x(d[3]) );
	dmg_notif1 g247 (.ena(w306), .a(w155), .x(d[4]) );
	dmg_notif1 g248 (.ena(w127), .a(w126), .x(d[2]) );
	dmg_notif1 g249 (.ena(w138), .a(w137), .x(d[5]) );
	dmg_notif1 g250 (.ena(w138), .a(w116), .x(d[6]) );
	dmg_notif1 g251 (.ena(w89), .a(w301), .x(d[7]) );
	dmg_notif1 g252 (.ena(w33), .a(w218), .x(d[0]) );
	dmg_notif1 g253 (.ena(w89), .a(w220), .x(d[0]) );
	dmg_notif1 g254 (.ena(w33), .a(w93), .x(d[4]) );
	dmg_notif1 g255 (.ena(w89), .a(w96), .x(d[4]) );
	dmg_notif1 g256 (.ena(w89), .a(w97), .x(d[5]) );
	dmg_notif1 g257 (.ena(w33), .a(w330), .x(d[5]) );
	dmg_notif1 g258 (.ena(w89), .a(w329), .x(d[3]) );
	dmg_notif1 g259 (.ena(w33), .a(w24), .x(d[3]) );
	dmg_notif1 g260 (.ena(w138), .a(w112), .x(d[4]) );
	...
	dmg_or g277 (.a(d[1]), .b(w32), .x(w67) );
	dmg_and3 g278 (.a(a[2]), .b(w302), .c(w147), .x(w100) );
	dmg_nand g279 (.a(w286), .b(w8), .x(w34) );
	dmg_or g280 (.a(d[2]), .b(w32), .x(w219) );
	dmg_nand3 g281 (.a(w69), .b(w165), .c(d[3]), .x(w22) );
	dmg_nand4 g282 (.a(a[0]), .b(w108), .c(w109), .d(w100), .x(w99) );
	dmg_nand4 g283 (.a(w110), .b(a[1]), .c(w109), .d(w100), .x(w223) );
	dmg_nand3 g284 (.a(w69), .b(w70), .c(d[4]), .x(w133) );
	dmg_nand3 g285 (.a(w38), .b(w159), .c(w55), .x(w54) );
	dmg_const g286 (.q0(w20), .q1(w21) );
	dmg_nand3 g287 (.a(w69), .b(w66), .c(d[1]), .x(w243) );
	dmg_nand3 g288 (.a(w69), .b(w191), .c(d[0]), .x(w299) );
	dmg_nand3 g289 (.a(w208), .b(w63), .c(w269), .x(w16) );
	dmg_or g290 (.a(w204), .b(w99), .x(w208) );
	dmg_or g291 (.a(w196), .b(w197), .x(w43) );
	dmg_or g292 (.a(d[0]), .b(w32), .x(w298) );
	dmg_or g293 (.a(w195), .b(w88), .x(w194) );
	dmg_or g294 (.a(d[3]), .b(w32), .x(w164) );
	dmg_or g295 (.a(d[4]), .b(w32), .x(w135) );
	dmg_or g296 (.a(w55), .b(w56), .x(w57) );
	dmg_nor5 g297 (.a(a[7]), .b(a[6]), .c(a[5]), .d(a[4]), .e(a[3]), .x(w302) );
	dmg_nor4 g298 (.a(a[7]), .b(a[6]), .c(a[5]), .d(a[4]), .x(w101) );
	dmg_and3 g299 (.a(w303), .b(w302), .c(w147), .x(w146) );
	dmg_and4 g300 (.a(a[0]), .b(a[1]), .c(a[2]), .d(a[3]), .x(w246) );
	dmg_and4 g301 (.a(w100), .b(w45), .c(a[1]), .d(a[0]), .x(w127) );
	dmg_nand4 g302 (.a(a[0]), .b(a[1]), .c(w109), .d(w100), .x(w148) );
	dmg_nand3 g303 (.a(w69), .b(w254), .c(d[2]), .x(w253) );
	dmg_and3 g304 (.a(w219), .b(w254), .c(w63), .x(w350) );
	dmg_nor3 g305 (.a(w209), .b(w325), .c(w189), .x(w188) );
	dmg_and3 g306 (.a(w67), .b(w66), .c(w63), .x(w256) );
	dmg_nand4 g307 (.a(a[0]), .b(w108), .c(w109), .d(w146), .x(w357) );
	dmg_nand4 g308 (.a(w110), .b(a[1]), .c(w109), .d(w146), .x(w315) );
