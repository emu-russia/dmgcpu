module Arbiter (  clk2, n_reset2, cpu_mreq, ext_cs_en, cpu_wr_sync, a, d, cpu_wr, mmio_sel, boot_sel, 
	...
	dmg_nand g1 (.a(d[5]), .b(w48), .x(w1) );
	dmg_nand g2 (.a(d[3]), .b(w48), .x(w65) );
	dmg_nand g3 (.a(d[2]), .b(w48), .x(w64) );
	dmg_nand g4 (.a(d[0]), .b(w48), .x(w66) );
	dmg_nand g5 (.a(d[1]), .b(w48), .x(w229) );
	dmg_nand g6 (.a(d[7]), .b(w48), .x(w234) );
	dmg_nand g7 (.a(d[6]), .b(w48), .x(w221) );
	...
	dmg_not g18 (.a(md[2]), .x(w107) );
	dmg_not g19 (.a(md[1]), .x(w123) );
	dmg_not g20 (.a(md[3]), .x(w95) );
	dmg_not g21 (.a(md[6]), .x(w183) );
	dmg_not g22 (.a(md[5]), .x(w182) );
	dmg_not g23 (.a(md[0]), .x(w230) );
	...
	dmg_and g33 (.a(md[6]), .b(w33), .x(w103) );
	dmg_and g34 (.a(md[1]), .b(w33), .x(w44) );
	dmg_and g35 (.a(md[5]), .b(w33), .x(w220) );
	dmg_and g36 (.a(md[2]), .b(w33), .x(w215) );
	dmg_and g37 (.a(md[0]), .b(w33), .x(w219) );
	dmg_and g38 (.a(md[3]), .b(w33), .x(w97) );
	dmg_and g39 (.a(md[4]), .b(w33), .x(w206) );
	dmg_and g40 (.a(md[7]), .b(w33), .x(w205) );
	dmg_and g41 (.a(a[15]), .b(w23), .x(w22) );
	...
	dmg_nor g46 (.a(w30), .b(d[0]), .x(w62) );
	dmg_nor g47 (.a(w30), .b(d[4]), .x(w63) );
	dmg_nor g48 (.a(w30), .b(d[1]), .x(w228) );
	dmg_nor g49 (.a(w60), .b(w25), .x(w61) );
	dmg_nor g50 (.a(w30), .b(d[7]), .x(w153) );
	dmg_nor g51 (.a(w30), .b(d[6]), .x(w154) );
	dmg_nor g52 (.a(w189), .b(w139), .x(w114) );
	dmg_nor g53 (.a(a[15]), .b(w225), .x(w57) );
	dmg_nor g54 (.a(w30), .b(d[2]), .x(w161) );
	dmg_nor g55 (.a(w30), .b(d[3]), .x(w160) );
	dmg_nor g56 (.a(w30), .b(d[5]), .x(w110) );
	...
	dmg_nand g85 (.a(d[4]), .b(w48), .x(w54) );
	dmg_notif0 g86 (.n_ena(w159), .a(w155), .x(d[1]) );
	dmg_notif0 g87 (.n_ena(w159), .a(w162), .x(d[0]) );
	dmg_notif0 g88 (.n_ena(w159), .a(w163), .x(d[2]) );
	dmg_notif1 g89 (.ena(w43), .a(w211), .x(md[1]) );
	dmg_notif1 g90 (.ena(w43), .a(w100), .x(md[6]) );
	dmg_notif1 g91 (.ena(w43), .a(w202), .x(md[2]) );
	dmg_notif1 g92 (.ena(w43), .a(w98), .x(md[5]) );
	dmg_notif1 g93 (.ena(w43), .a(w209), .x(md[3]) );
	dmg_notif1 g94 (.ena(w43), .a(w208), .x(md[0]) );
	dmg_notif1 g95 (.ena(w43), .a(w201), .x(md[7]) );
	dmg_notif1 g96 (.ena(w43), .a(w99), .x(md[4]) );
	dmg_notif1 g97 (.ena(w7), .a(w107), .x(d[2]) );
	dmg_notif1 g98 (.ena(w7), .a(w123), .x(d[1]) );
	dmg_notif1 g99 (.ena(w7), .a(w95), .x(d[3]) );
	dmg_notif1 g100 (.ena(w7), .a(w183), .x(d[6]) );
	dmg_notif1 g101 (.ena(w7), .a(w182), .x(d[5]) );
	dmg_notif1 g102 (.ena(w7), .a(w230), .x(d[0]) );
	dmg_notif1 g103 (.ena(w190), .a(w171), .x(d[0]) );
	dmg_notif0 g104 (.n_ena(w159), .a(w222), .x(d[5]) );
	dmg_notif0 g105 (.n_ena(w159), .a(w164), .x(d[6]) );
	dmg_notif0 g106 (.n_ena(w159), .a(w158), .x(d[3]) );
	dmg_notif0 g107 (.n_ena(w159), .a(w223), .x(d[4]) );
	dmg_notif0 g108 (.n_ena(w159), .a(w166), .x(d[7]) );
	dmg_notif1 g109 (.ena(w7), .a(w124), .x(d[4]) );
	dmg_bufif0 g110 (.a0(d[5]), .n_ena(w32), .a1(d[5]), .x(md[5]) );
	dmg_bufif0 g111 (.a0(w69), .n_ena(w68), .a1(w69), .x(d[7]) );
	dmg_bufif0 g112 (.a0(w67), .n_ena(w68), .a1(w67), .x(d[2]) );
	dmg_bufif0 g113 (.a0(w157), .n_ena(w68), .a1(w157), .x(d[1]) );
	dmg_bufif0 g114 (.a0(w121), .n_ena(w68), .a1(w121), .x(d[5]) );
	dmg_bufif0 g115 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[1]) );
	dmg_bufif0 g116 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[2]) );
	dmg_bufif0 g117 (.a0(w3), .n_ena(w4), .a1(w3), .x(a[15]) );
	dmg_bufif0 g118 (.a0(d[7]), .n_ena(w32), .a1(d[7]), .x(md[7]) );
	dmg_bufif0 g119 (.a0(d[3]), .n_ena(w32), .a1(d[3]), .x(md[3]) );
	dmg_bufif0 g120 (.a0(d[4]), .n_ena(w32), .a1(d[4]), .x(md[4]) );
	dmg_bufif0 g121 (.a0(d[0]), .n_ena(w32), .a1(d[0]), .x(md[0]) );
	dmg_bufif0 g122 (.a0(d[2]), .n_ena(w32), .a1(d[2]), .x(md[2]) );
	dmg_bufif0 g123 (.a0(d[6]), .n_ena(w32), .a1(d[6]), .x(md[6]) );
	dmg_bufif0 g124 (.a0(d[1]), .n_ena(w32), .a1(d[1]), .x(md[1]) );
	dmg_bufif0 g125 (.a0(w186), .n_ena(w68), .a1(w186), .x(d[0]) );
	dmg_bufif0 g126 (.a0(w185), .n_ena(w68), .a1(w185), .x(d[6]) );
	dmg_bufif0 g127 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[7]) );
	dmg_bufif0 g128 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[6]) );
	dmg_bufif0 g129 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[0]) );
	dmg_bufif0 g130 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[3]) );
	dmg_bufif0 g131 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[5]) );
	dmg_bufif0 g132 (.a0(w26), .n_ena(w49), .a1(w26), .x(d[4]) );
	dmg_bufif0 g133 (.a0(w227), .n_ena(w68), .a1(w227), .x(d[4]) );
	dmg_bufif0 g134 (.a0(w109), .n_ena(w68), .a1(w109), .x(d[3]) );
	...
	dmg_notif1 g143 (.ena(w7), .a(w6), .x(d[7]) );
	dmg_or g144 (.a(w86), .b(w80), .x(w79) );
	dmg_or g145 (.a(w13), .b(w11), .x(w12) );
	dmg_or g146 (.a(w32), .b(md[2]), .x(w214) );
	dmg_or g147 (.a(w32), .b(md[1]), .x(w104) );
	dmg_or g148 (.a(w32), .b(md[6]), .x(w39) );
	dmg_or g149 (.a(w32), .b(md[5]), .x(w36) );
	dmg_or g150 (.a(w32), .b(md[0]), .x(w216) );
	dmg_or g151 (.a(w32), .b(md[3]), .x(w200) );
	dmg_or g152 (.a(w32), .b(md[7]), .x(w199) );
	dmg_or g153 (.a(w32), .b(md[4]), .x(w181) );
	dmg_or g154 (.a(d[0]), .b(w170), .x(w191) );
	...
	dmg_and3 g170 (.a(w137), .b(w180), .c(a[15]), .x(w179) );
	dmg_nand4 g171 (.a(w125), .b(w116), .c(w114), .d(w113), .x(w187) );
	dmg_and4 g172 (.a(w115), .b(w114), .c(w116), .d(w125), .x(w190) );
	dmg_nor8 g173 (.a(a[15]), .b(w138), .c(w137), .d(w136), .e(w135), .f(w134), .g(w133), .h(w132), .x(w168) );
	dmg_nand7 g174 (.a(a[15]), .b(w138), .c(w137), .d(w136), .e(w135), .f(w133), .g(w133), .x(w139) );
