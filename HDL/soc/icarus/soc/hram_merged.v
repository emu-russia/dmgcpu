module HRAM (  clk7, soc_rd, soc_wr, d, ffxx, a);
	...
	sram_bit_lane g1 (.db(d[2]), .n_oe(w10), .n_pch(w9), .oe(w6), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w56), .bl(w57) );
	sram_bit_lane g2 (.db(d[3]), .n_pch(w9), .n_oe(w10), .oe(w6), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w54), .bl(w55) );
	sram_bit_lane g3 (.db(d[4]), .oe(w6), .n_pch(w9), .n_oe(w10), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w52), .bl(w53) );
	sram_bit_lane g4 (.db(d[5]), .n_pch(w9), .n_oe(w10), .oe(w6), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w50), .bl(w51) );
	sram_bit_lane g5 (.db(d[6]), .oe(w6), .n_pch(w9), .n_oe(w10), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w48), .bl(w49) );
	sram_bit_lane g6 (.db(d[7]), .oe(w6), .n_pch(w9), .n_oe(w10), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w47), .bl(w46) );
	sram_bit_lane g7 (.db(d[0]), .oe(w6), .n_pch(w9), .n_oe(w10), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w60), .bl(w61) );
	sram_bit_lane g8 (.db(d[1]), .oe(w6), .n_pch(w9), .n_oe(w10), .wr(w8), .col({w30,w33,w32,w31}), .n_bl(w58), .bl(w59) );
