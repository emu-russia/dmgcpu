module APU (  cclk, clk2, clk4, clk6, clk7, clk9, n_reset2, a, d, cpu_wakeup, n_DRV_HIGH_a, n_INPUT_a, DRV_LOW_a,  
	...
	dmg_notif0 g869 (.n_ena(w548), .a(w739), .x(d[6]) );
	...
	dmg_notif0 g937 (.n_ena(w548), .a(w747), .x(d[0]) );
	dmg_notif0 g938 (.n_ena(w555), .a(w106), .x(d[3]) );
	dmg_notif0 g939 (.n_ena(w548), .a(w1212), .x(d[3]) );
	dmg_notif0 g940 (.n_ena(w548), .a(w740), .x(d[1]) );
	dmg_notif0 g941 (.n_ena(w548), .a(w1240), .x(d[2]) );
