module APU (  cclk, clk2, clk4, clk6, clk7, clk9, n_reset2, a, d, cpu_wakeup, n_DRV_HIGH_a, n_INPUT_a, DRV_LOW_a,  
	...
	// w548_r: bus-model fix for Icarus (see STATUS.md / make_wc.py):
	...
	dmg_not g17 (.a(a[4]), .x(w710) );
	dmg_not g18 (.a(a[7]), .x(w1204) );
	dmg_not g19 (.a(a[6]), .x(w1200) );
	dmg_not g20 (.a(w11), .x(w12) );
	dmg_not g21 (.a(w8), .x(w580) );
	dmg_not g22 (.a(a[6]), .x(w113) );
	...
	dmg_not g217 (.a(d[6]), .x(w31) );
	dmg_not g218 (.a(w624), .x(w625) );
	dmg_not g219 (.a(d[0]), .x(w512) );
	...
	dmg_not g243 (.a(d[1]), .x(w1347) );
	dmg_not g244 (.a(d[0]), .x(w1348) );
	...
	dmg_dffr g284 (.clk(w1199), .nr1(w559), .nr2(w559), .d(d[1]), .q(w712) );
	...
	dmg_dffr g293 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[5]), .nq(w797) );
	...
	dmg_dffr g324 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[0]), .q(w846) );
	dmg_dffr g325 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[2]), .q(w619) );
	...
	dmg_dffr g339 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[1]), .q(w560) );
	dmg_dffr g340 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[4]), .nq(w620) );
	dmg_dffr g341 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[7]), .q(w803) );
	dmg_dffr g342 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[3]), .q(w1381) );
	dmg_dffr g343 (.clk(w570), .nr1(w559), .nr2(w559), .d(d[6]), .q(w56) );
	...
	dmg_dffr g347 (.clk(w1255), .nr1(w1276), .nr2(w1276), .d(d[7]), .nq(w1235) );
	...
	dmg_dffr g382 (.clk(w1199), .nr1(w559), .nr2(w559), .d(d[0]), .q(w618) );
	dmg_dffr g383 (.clk(w709), .nr1(w19), .nr2(w19), .d(d[5]), .q(w86) );
	...
	dmg_cnt g387 (.d(d[5]), .load(w708), .nq(w1167), .clk(w1160) );
	...
	dmg_cnt g393 (.d(d[3]), .load(w321), .nq(w286), .clk(w82) );
	...
	dmg_cnt g397 (.q(w954), .d(d[1]), .load(w952), .clk(w1329) );
	dmg_cnt g398 (.d(d[3]), .load(w952), .nq(w963), .clk(w953) );
	dmg_cnt g399 (.q(w1263), .d(d[4]), .load(w1264), .clk(w1302) );
	dmg_cnt g400 (.q(w1171), .d(d[1]), .load(w571), .clk(w1170) );
	dmg_cnt g401 (.q(w759), .d(d[2]), .load(w571), .clk(w1171) );
	dmg_cnt g402 (.d(d[3]), .load(w571), .nq(w758), .clk(w759) );
	dmg_cnt g403 (.d(w750), .load(w646), .nq(w1212), .clk(w1238) );
	dmg_cnt g404 (.q(w1238), .d(w1239), .load(w646), .nq(w1240), .clk(w653) );
	dmg_cnt g405 (.q(w1170), .d(d[0]), .load(w571), .clk(w1174) );
	dmg_cnt g406 (.d(d[5]), .load(w1264), .nq(w1265), .clk(w1263) );
	...
	dmg_cnt g410 (.d(d[5]), .load(w319), .nq(w819), .clk(w852) );
	dmg_cnt g411 (.q(w330), .d(w860), .load(w845), .nq(w326), .clk(w325) );
	dmg_cnt g412 (.d(d[3]), .load(w916), .nq(w1278), .clk(w540) );
	dmg_cnt g413 (.q(w540), .d(d[2]), .load(w916), .clk(w1373) );
	dmg_cnt g414 (.q(w1279), .d(d[0]), .load(w916), .clk(w1280) );
	dmg_cnt g415 (.q(w536), .d(d[4]), .load(w170), .clk(w1277) );
	...
	dmg_cnt g455 (.q(w852), .d(d[4]), .load(w319), .clk(w285) );
	dmg_cnt g456 (.q(w81), .d(d[1]), .load(w321), .clk(w80) );
	dmg_cnt g457 (.q(w159), .d(w764), .load(w160), .nq(w1191), .clk(w158) );
	dmg_cnt g458 (.q(w1373), .d(d[1]), .load(w916), .clk(w1279) );
	dmg_cnt g459 (.d(d[7]), .load(w170), .nq(w494), .clk(w171) );
	dmg_cnt g460 (.q(w171), .d(d[6]), .load(w170), .clk(w1393) );
	dmg_cnt g461 (.q(w1393), .d(d[5]), .load(w170), .clk(w536) );
	...
	dmg_cnt g470 (.q(w82), .d(d[2]), .load(w321), .clk(w81) );
	dmg_cnt g471 (.q(w80), .d(d[0]), .load(w321), .clk(w79) );
	dmg_cnt g472 (.q(w1082), .d(w1090), .load(w1028), .clk(w1081) );
	dmg_cnt g473 (.q(w1329), .d(d[0]), .load(w952), .clk(w1294) );
	dmg_cnt g474 (.q(w953), .d(d[2]), .load(w952), .clk(w954) );
	dmg_cnt g475 (.q(w1160), .d(d[4]), .load(w708), .clk(w1333) );
	dmg_latchr_comp g476 (.n_ena(w230), .d(d[4]), .ena(w142), .nres(w942), .nq(w1076) );
	dmg_latchr_comp g477 (.n_ena(w230), .d(d[3]), .ena(w142), .nres(w942), .nq(w1079) );
	dmg_latchr_comp g478 (.n_ena(w230), .d(d[2]), .ena(w142), .nres(w942), .nq(w1090) );
	dmg_latchr_comp g479 (.n_ena(w230), .d(d[1]), .ena(w142), .nres(w942), .nq(w1080) );
	dmg_latchr_comp g480 (.n_ena(w1104), .d(d[0]), .ena(w988), .nres(w19), .q(w18), .nq(w1154) );
	dmg_latchr_comp g481 (.n_ena(w1104), .d(d[3]), .ena(w988), .nres(w19), .q(w17), .nq(w813) );
	dmg_latchr_comp g482 (.n_ena(w1103), .d(d[0]), .ena(w228), .nres(w19), .nq(w227) );
	dmg_latchr_comp g483 (.n_ena(w1103), .d(d[3]), .ena(w228), .nres(w19), .q(w815), .nq(w814) );
	dmg_latchr_comp g484 (.n_ena(w1103), .d(d[2]), .ena(w228), .nres(w19), .nq(w1153) );
	dmg_latchr_comp g485 (.n_ena(w1074), .d(d[6]), .ena(w1075), .nres(w19), .nq(w224) );
	dmg_latchr_comp g486 (.n_ena(w69), .d(d[6]), .ena(w1107), .nres(w1106), .q(w76), .nq(w77) );
	dmg_latchr_comp g487 (.n_ena(w625), .d(d[6]), .ena(w624), .nres(w626), .q(w485), .nq(w484) );
	...
	dmg_latchr_comp g492 (.n_ena(w1172), .d(d[7]), .ena(w1150), .nres(w1384), .q(w1318) );
	dmg_latchr_comp g493 (.n_ena(w510), .d(d[6]), .ena(w511), .nres(w509), .q(w508), .nq(w506) );
	dmg_latchr_comp g494 (.n_ena(w1180), .d(d[1]), .ena(w1179), .nres(w338), .q(w1118), .nq(w1119) );
	dmg_latchr_comp g495 (.n_ena(w1180), .d(d[2]), .ena(w1179), .nres(w338), .q(w1182), .nq(w994) );
	dmg_latchr_comp g496 (.n_ena(w1180), .d(d[0]), .ena(w1179), .nres(w338), .q(w1117), .nq(w967) );
	dmg_latchr_comp g497 (.n_ena(w337), .d(d[6]), .ena(w810), .nres(w338), .q(w480), .nq(w54) );
	dmg_latchr_comp g498 (.n_ena(w337), .d(d[5]), .ena(w810), .nres(w338), .q(w339), .nq(w1370) );
	dmg_latchr_comp g499 (.n_ena(w337), .d(d[7]), .ena(w810), .nres(w338), .q(w481), .nq(w482) );
	dmg_latchr_comp g500 (.n_ena(w337), .d(d[3]), .ena(w810), .nres(w338), .q(w134), .nq(w616) );
	dmg_latchr_comp g501 (.n_ena(w337), .d(d[4]), .ena(w810), .nres(w338), .q(w1269), .nq(w1270) );
	dmg_latchr_comp g502 (.n_ena(w974), .d(d[6]), .ena(w975), .nres(w818), .q(w1016), .nq(w1111) );
	dmg_latchr_comp g503 (.n_ena(w974), .d(d[7]), .ena(w975), .nres(w818), .q(w973), .nq(w475) );
	dmg_latchr_comp g504 (.n_ena(w1193), .d(d[7]), .ena(w1194), .nres(w1192), .q(w409), .nq(w408) );
	dmg_latchr_comp g505 (.n_ena(w722), .d(d[5]), .ena(w1211), .nres(w363), .q(w351), .nq(w350) );
	dmg_latchr_comp g506 (.n_ena(w722), .d(d[6]), .ena(w1211), .nres(w363), .q(w348), .nq(w349) );
	dmg_latchr_comp g507 (.n_ena(w722), .d(d[4]), .ena(w1211), .nres(w363), .q(w352), .nq(w557) );
	dmg_latchr_comp g508 (.n_ena(w722), .d(d[7]), .ena(w1211), .nres(w363), .q(w361), .nq(w360) );
	dmg_latchr_comp g509 (.n_ena(w548), .d(d[7]), .ena(w1251), .nres(w749), .q(w1357) );
	dmg_latchr_comp g510 (.n_ena(w548), .d(d[6]), .ena(w1251), .nres(w749), .q(w549) );
	dmg_latchr_comp g511 (.n_ena(w548), .d(d[5]), .ena(w1251), .nres(w749), .q(w1337) );
	dmg_latchr_comp g512 (.n_ena(w553), .d(d[7]), .ena(w554), .nres(w592), .q(w593) );
	dmg_latchr_comp g513 (.n_ena(w182), .d(d[1]), .ena(w181), .nres(w197), .q(w1286) );
	dmg_latchr_comp g514 (.n_ena(w182), .d(d[0]), .ena(w181), .nres(w197), .q(w734) );
	dmg_latchr_comp g515 (.n_ena(w182), .d(d[2]), .ena(w181), .nres(w197), .q(w736) );
	dmg_latchr_comp g516 (.n_ena(w450), .d(d[0]), .ena(w451), .nres(w458), .q(w457) );
	dmg_latchr_comp g517 (.n_ena(w450), .d(d[2]), .ena(w451), .nres(w458), .q(w455) );
	dmg_latchr_comp g518 (.n_ena(w450), .d(d[1]), .ena(w451), .nres(w458), .q(w606) );
	dmg_latchr_comp g519 (.n_ena(w201), .d(d[1]), .ena(w200), .nres(w194), .q(w448) );
	dmg_latchr_comp g520 (.n_ena(w201), .d(d[4]), .ena(w200), .nres(w194), .q(w193) );
	dmg_latchr_comp g521 (.n_ena(w201), .d(d[3]), .ena(w200), .nres(w194), .q(w731) );
	dmg_latchr_comp g522 (.n_ena(w201), .d(d[2]), .ena(w200), .nres(w194), .q(w199) );
	dmg_latchr_comp g523 (.n_ena(w202), .d(d[5]), .ena(w203), .nres(w194), .q(w195) );
	dmg_latchr_comp g524 (.n_ena(w1227), .d(d[0]), .ena(w724), .nres(w430), .q(w1285), .nq(w1228) );
	dmg_latchr_comp g525 (.n_ena(w1227), .d(d[2]), .ena(w724), .nres(w430), .q(w429), .nq(w374) );
	dmg_latchr_comp g526 (.n_ena(w1227), .d(d[1]), .ena(w724), .nres(w430), .q(w1284), .nq(w1283) );
	dmg_latchr_comp g527 (.n_ena(w851), .d(d[5]), .ena(w1282), .nres(w430), .q(w214), .nq(w213) );
	dmg_latchr_comp g528 (.n_ena(w851), .d(d[4]), .ena(w1282), .nres(w430), .q(w438), .nq(w850) );
	dmg_latchr_comp g529 (.n_ena(w851), .d(d[6]), .ena(w1282), .nres(w430), .q(w848), .nq(w849) );
	dmg_latchr_comp g530 (.n_ena(w851), .d(d[3]), .ena(w1282), .nres(w430), .q(w439), .nq(w433) );
	dmg_latchr_comp g531 (.n_ena(w851), .d(d[7]), .ena(w1282), .nres(w430), .q(w530), .nq(w431) );
	dmg_latchr_comp g532 (.n_ena(w1377), .d(d[1]), .ena(w1271), .nres(w139), .nq(w332) );
	dmg_latchr_comp g533 (.n_ena(w1377), .d(d[2]), .ena(w1271), .nres(w139), .nq(w1272) );
	dmg_latchr_comp g534 (.n_ena(w1377), .d(d[0]), .ena(w1271), .nres(w139), .nq(w138) );
	dmg_latchr_comp g535 (.n_ena(w334), .d(d[3]), .ena(w335), .nres(w52), .q(w783), .nq(w782) );
	dmg_latchr_comp g536 (.n_ena(w202), .d(d[6]), .ena(w203), .nres(w194), .q(w464) );
	dmg_latchr_comp g537 (.n_ena(w202), .d(d[7]), .ena(w203), .nres(w194), .q(w375) );
	dmg_latchr_comp g538 (.n_ena(w201), .d(d[0]), .ena(w200), .nres(w194), .q(w449) );
	dmg_latchr_comp g539 (.n_ena(w1356), .d(d[5]), .ena(w1355), .nres(w1354), .q(w591), .nq(w588) );
	dmg_latchr_comp g540 (.n_ena(w1356), .d(d[6]), .ena(w1355), .nres(w1354), .q(w589), .nq(w590) );
	dmg_latchr_comp g541 (.n_ena(w675), .d(d[1]), .ena(w674), .nres(w363), .q(w1257), .nq(w364) );
	dmg_latchr_comp g542 (.n_ena(w675), .d(d[2]), .ena(w674), .nres(w363), .q(w1256), .nq(w633) );
	dmg_latchr_comp g543 (.n_ena(w675), .d(d[0]), .ena(w674), .nres(w363), .q(w728), .nq(w729) );
	dmg_latchr_comp g544 (.n_ena(w537), .d(d[6]), .ena(w538), .nres(w1217), .q(w497), .nq(w498) );
	dmg_latchr_comp g545 (.n_ena(w821), .d(d[7]), .ena(w1358), .nres(w261), .q(w260) );
	dmg_latchr_comp g546 (.n_ena(w974), .d(d[4]), .ena(w975), .nres(w818), .q(w982), .nq(w971) );
	dmg_latchr_comp g547 (.n_ena(w974), .d(d[5]), .ena(w975), .nres(w818), .q(w983), .nq(w972) );
	dmg_latchr_comp g548 (.n_ena(w722), .d(d[3]), .ena(w1211), .nres(w363), .q(w502), .nq(w358) );
	dmg_latchr_comp g549 (.n_ena(w1250), .d(w1252), .ena(w638), .nres(w19), .q(w1029), .nq(w1210) );
	dmg_latchr_comp g550 (.n_ena(w651), .d(d[4]), .ena(w650), .nres(w749), .q(w1289) );
	dmg_latchr_comp g551 (.n_ena(w651), .d(d[3]), .ena(w650), .nres(w749), .q(w750) );
	dmg_latchr_comp g552 (.n_ena(w651), .d(d[2]), .ena(w650), .nres(w749), .q(w1239) );
	dmg_latchr_comp g553 (.n_ena(w651), .d(d[1]), .ena(w650), .nres(w749), .q(w652) );
	dmg_latchr_comp g554 (.n_ena(w651), .d(d[0]), .ena(w650), .nres(w749), .q(w748) );
	dmg_latchr_comp g555 (.n_ena(w625), .d(d[7]), .ena(w624), .nres(w626), .q(w629), .nq(w630) );
	dmg_latchr_comp g556 (.n_ena(w1006), .d(d[7]), .ena(w1007), .nres(w921), .q(w922) );
	dmg_latchr_comp g557 (.n_ena(w1103), .d(d[1]), .ena(w228), .nres(w19), .nq(w376) );
	dmg_latchr_comp g558 (.n_ena(w1104), .d(d[1]), .ena(w988), .nres(w19), .q(w1108), .nq(w1105) );
	dmg_latchr_comp g559 (.n_ena(w1104), .d(d[2]), .ena(w988), .nres(w19), .q(w816), .nq(w817) );
	dmg_latchr_comp g560 (.n_ena(w1074), .d(d[5]), .ena(w1075), .nres(w19), .nq(w1151) );
	dmg_latchr_comp g561 (.n_ena(w1074), .d(d[7]), .ena(w1075), .nres(w19), .q(w1109), .nq(w1110) );
	dmg_latchr_comp g562 (.n_ena(w1074), .d(d[4]), .ena(w1075), .nres(w19), .nq(w226) );
	dmg_latchr_comp g563 (.n_ena(w191), .d(d[5]), .ena(w190), .nres(w19), .q(w1072), .nq(w1073) );
	dmg_latchr_comp g564 (.n_ena(w191), .d(d[4]), .ena(w190), .nres(w19), .q(w1094), .nq(w1093) );
	dmg_latchr_comp g565 (.n_ena(w191), .d(d[6]), .ena(w190), .nres(w19), .q(w1047), .nq(w840) );
	dmg_latchr_comp g566 (.n_ena(w191), .d(d[7]), .ena(w190), .nres(w19), .q(w1048), .nq(w1049) );
	dmg_latchr_comp g567 (.n_ena(w230), .d(d[5]), .ena(w142), .nres(w942), .nq(w309) );
	dmg_latchr_comp g568 (.n_ena(w230), .d(d[0]), .ena(w142), .nres(w942), .nq(w940) );
	dmg_latchr_comp g569 (.n_ena(w230), .d(d[6]), .ena(w142), .nres(w942), .nq(w941) );
	dmg_latchr_comp g570 (.n_ena(w944), .d(d[6]), .ena(w945), .nres(w946), .q(w23), .nq(w1100) );
	dmg_latchr_comp g571 (.n_ena(w663), .d(d[6]), .ena(w1122), .nres(w40), .q(w34), .nq(w35) );
	dmg_latchr_comp g572 (.n_ena(w663), .d(d[7]), .ena(w1122), .nres(w40), .q(w37), .nq(w36) );
	...
	dmg_not2 g578 (.a(a[2]), .x(w206) );
	dmg_not2 g579 (.a(a[1]), .x(w62) );
	dmg_not2 g580 (.a(a[3]), .x(w208) );
	...
	dmg_nand g751 (.a(d[2]), .b(w294), .x(w1309) );
	...
	dmg_nand g756 (.a(d[6]), .b(w30), .x(w558) );
	dmg_nand g757 (.a(d[7]), .b(w30), .x(w172) );
	dmg_nand g758 (.a(w631), .b(w504), .x(w510) );
	dmg_nand g759 (.a(w764), .b(w236), .x(w302) );
	dmg_nand g760 (.a(w874), .b(w236), .x(w264) );
	dmg_nand g761 (.a(d[3]), .b(w30), .x(w884) );
	dmg_nand g762 (.a(d[0]), .b(w30), .x(w1114) );
	dmg_nand g763 (.a(d[2]), .b(w30), .x(w788) );
	dmg_nand g764 (.a(d[1]), .b(w30), .x(w259) );
	...
	dmg_nand g773 (.a(d[4]), .b(w30), .x(w417) );
	dmg_nand g774 (.a(d[5]), .b(w30), .x(w1326) );
	...
	dmg_nand g807 (.a(d[1]), .b(w294), .x(w304) );
	dmg_nand g808 (.a(d[0]), .b(w294), .x(w293) );
	...
	dmg_notif0 g833 (.n_ena(w225), .a(w1153), .x(d[2]) );
	dmg_notif0 g834 (.n_ena(w225), .a(w376), .x(d[1]) );
	dmg_notif0 g835 (.n_ena(w225), .a(w814), .x(d[3]) );
	dmg_notif0 g836 (.n_ena(w225), .a(w227), .x(d[0]) );
	dmg_notif0 g837 (.n_ena(w225), .a(w1151), .x(d[5]) );
	dmg_notif0 g838 (.n_ena(w225), .a(w1110), .x(d[7]) );
	dmg_notif0 g839 (.n_ena(w225), .a(w226), .x(d[4]) );
	dmg_notif0 g840 (.n_ena(w1052), .a(w987), .x(d[0]) );
	dmg_notif0 g841 (.n_ena(w310), .a(w940), .x(d[0]) );
	dmg_notif0 g842 (.n_ena(w310), .a(w1090), .x(d[2]) );
	dmg_notif0 g843 (.n_ena(w310), .a(w1080), .x(d[1]) );
	dmg_notif0 g844 (.n_ena(w310), .a(w941), .x(d[6]) );
	dmg_notif0 g845 (.n_ena(w310), .a(w1079), .x(d[3]) );
	dmg_notif0 g846 (.n_ena(w310), .a(w1076), .x(d[4]) );
	dmg_notif0 g847 (.n_ena(w310), .a(w309), .x(d[5]) );
	dmg_notif0 g848 (.n_ena(w15), .a(w20), .x(d[0]) );
	dmg_notif0 g849 (.n_ena(w15), .a(w20), .x(d[5]) );
	dmg_notif0 g850 (.n_ena(w15), .a(w20), .x(d[2]) );
	dmg_notif0 g851 (.n_ena(w15), .a(w20), .x(d[3]) );
	dmg_notif0 g852 (.n_ena(w15), .a(w20), .x(d[1]) );
	dmg_notif0 g853 (.n_ena(w15), .a(w20), .x(d[6]) );
	dmg_notif0 g854 (.n_ena(w643), .a(w35), .x(d[6]) );
	dmg_notif0 g855 (.n_ena(w643), .a(w36), .x(d[7]) );
	dmg_notif0 g856 (.n_ena(w413), .a(w630), .x(d[7]) );
	dmg_notif0 g857 (.n_ena(w993), .a(w994), .x(d[2]) );
	dmg_notif0 g858 (.n_ena(w993), .a(w1119), .x(d[1]) );
	dmg_notif0 g859 (.n_ena(w116), .a(w797), .x(d[5]) );
	dmg_notif0 g860 (.n_ena(w812), .a(w1093), .x(d[4]) );
	dmg_notif0 g861 (.n_ena(w812), .a(w840), .x(d[6]) );
	dmg_notif0 g862 (.n_ena(w828), .a(w827), .x(d[0]) );
	dmg_notif0 g863 (.n_ena(w812), .a(w1049), .x(d[7]) );
	dmg_notif0 g864 (.n_ena(w812), .a(w1073), .x(d[5]) );
	dmg_notif0 g865 (.n_ena(w1113), .a(w77), .x(d[6]) );
	dmg_notif0 g866 (.n_ena(w812), .a(w817), .x(d[2]) );
	dmg_notif0 g867 (.n_ena(w812), .a(w1105), .x(d[1]) );
	dmg_notif0 g868 (.n_ena(w1177), .a(w965), .x(d[1]) );
	dmg_notif0 g869 (.n_ena(w548_r), .a(w739), .x(d[6]) );
	dmg_notif0 g870 (.n_ena(w526), .a(w1321), .x(d[5]) );
	dmg_notif0 g871 (.n_ena(w526), .a(w1323), .x(d[4]) );
	dmg_notif0 g872 (.n_ena(w526), .a(w525), .x(d[7]) );
	dmg_notif0 g873 (.n_ena(w359), .a(w358), .x(d[3]) );
	dmg_notif0 g874 (.n_ena(w411), .a(w410), .x(d[7]) );
	dmg_notif0 g875 (.n_ena(w505), .a(w506), .x(d[6]) );
	dmg_notif0 g876 (.n_ena(w28), .a(w1191), .x(d[6]) );
	dmg_notif0 g877 (.n_ena(w28), .a(w535), .x(d[5]) );
	dmg_notif0 g878 (.n_ena(w28), .a(w329), .x(d[1]) );
	dmg_notif0 g879 (.n_ena(w474), .a(w971), .x(d[4]) );
	dmg_notif0 g880 (.n_ena(w474), .a(w1111), .x(d[6]) );
	dmg_notif0 g881 (.n_ena(w474), .a(w972), .x(d[5]) );
	dmg_notif0 g882 (.n_ena(w483), .a(w1370), .x(d[5]) );
	dmg_notif0 g883 (.n_ena(w483), .a(w616), .x(d[3]) );
	dmg_notif0 g884 (.n_ena(w116), .a(w779), .x(d[3]) );
	dmg_notif0 g885 (.n_ena(w432), .a(w431), .x(d[7]) );
	dmg_notif0 g886 (.n_ena(w212), .a(w1283), .x(d[1]) );
	dmg_notif0 g887 (.n_ena(w212), .a(w1228), .x(d[0]) );
	dmg_notif0 g888 (.n_ena(w212), .a(w374), .x(d[2]) );
	dmg_notif0 g889 (.n_ena(w177), .a(w462), .x(d[3]) );
	dmg_notif0 g890 (.n_ena(w177), .a(w634), .x(d[0]) );
	dmg_notif0 g891 (.n_ena(w177), .a(w636), .x(d[5]) );
	dmg_notif0 g892 (.n_ena(w609), .a(w1351), .x(d[1]) );
	dmg_notif0 g893 (.n_ena(w609), .a(w608), .x(d[2]) );
	dmg_notif0 g894 (.n_ena(w177), .a(w192), .x(d[4]) );
	dmg_notif0 g895 (.n_ena(w174), .a(w1287), .x(d[1]) );
	dmg_notif0 g896 (.n_ena(w174), .a(w184), .x(d[0]) );
	dmg_notif0 g897 (.n_ena(w177), .a(w186), .x(d[7]) );
	dmg_notif0 g898 (.n_ena(w177), .a(w459), .x(d[6]) );
	dmg_notif0 g899 (.n_ena(w177), .a(w447), .x(d[1]) );
	dmg_notif0 g900 (.n_ena(w177), .a(w178), .x(d[2]) );
	dmg_notif0 g901 (.n_ena(w116), .a(w620), .x(d[4]) );
	dmg_notif0 g902 (.n_ena(w28), .a(w1128), .x(d[4]) );
	dmg_notif0 g903 (.n_ena(w28), .a(w256), .x(d[3]) );
	dmg_notif0 g904 (.n_ena(w28), .a(w569), .x(d[2]) );
	dmg_notif0 g905 (.n_ena(w116), .a(w776), .x(d[0]) );
	dmg_notif0 g906 (.n_ena(w116), .a(w117), .x(d[2]) );
	dmg_notif0 g907 (.n_ena(w909), .a(w782), .x(d[3]) );
	dmg_notif0 g908 (.n_ena(w46), .a(w138), .x(d[0]) );
	dmg_notif0 g909 (.n_ena(w46), .a(w332), .x(d[1]) );
	dmg_notif0 g910 (.n_ena(w46), .a(w1272), .x(d[2]) );
	dmg_notif0 g911 (.n_ena(w47), .a(w1012), .x(d[3]) );
	dmg_notif0 g912 (.n_ena(w483), .a(w54), .x(d[6]) );
	dmg_notif0 g913 (.n_ena(w483), .a(w482), .x(d[7]) );
	dmg_notif0 g914 (.n_ena(w483), .a(w1270), .x(d[4]) );
	dmg_notif0 g915 (.n_ena(w474), .a(w475), .x(d[7]) );
	dmg_notif0 g916 (.n_ena(w432), .a(w433), .x(d[3]) );
	dmg_notif0 g917 (.n_ena(w432), .a(w849), .x(d[6]) );
	dmg_notif0 g918 (.n_ena(w432), .a(w850), .x(d[4]) );
	dmg_notif0 g919 (.n_ena(w499), .a(w498), .x(d[6]) );
	dmg_notif0 g920 (.n_ena(w432), .a(w213), .x(d[5]) );
	dmg_notif0 g921 (.n_ena(w1254), .a(w1235), .x(d[7]) );
	dmg_notif0 g922 (.n_ena(w359), .a(w350), .x(d[5]) );
	dmg_notif0 g923 (.n_ena(w359), .a(w349), .x(d[6]) );
	dmg_notif0 g924 (.n_ena(w359), .a(w557), .x(d[4]) );
	dmg_notif0 g925 (.n_ena(w359), .a(w360), .x(d[7]) );
	dmg_notif0 g926 (.n_ena(w632), .a(w729), .x(d[0]) );
	dmg_notif0 g927 (.n_ena(w632), .a(w364), .x(d[1]) );
	dmg_notif0 g928 (.n_ena(w632), .a(w633), .x(d[2]) );
	dmg_notif0 g929 (.n_ena(w907), .a(w588), .x(d[5]) );
	dmg_notif0 g930 (.n_ena(w907), .a(w590), .x(d[6]) );
	dmg_notif0 g931 (.n_ena(w609), .a(w908), .x(d[0]) );
	dmg_notif0 g932 (.n_ena(w174), .a(w1258), .x(d[2]) );
	dmg_notif0 g933 (.n_ena(w555), .a(w1262), .x(d[0]) );
	dmg_notif0 g934 (.n_ena(w555), .a(w654), .x(d[4]) );
	dmg_notif0 g935 (.n_ena(w555), .a(w669), .x(d[1]) );
	dmg_notif0 g936 (.n_ena(w555), .a(w107), .x(d[2]) );
	dmg_notif0 g937 (.n_ena(w548_r), .a(w747), .x(d[0]) );
	dmg_notif0 g938 (.n_ena(w555), .a(w106), .x(d[3]) );
	dmg_notif0 g939 (.n_ena(w548_r), .a(w1212), .x(d[3]) );
	dmg_notif0 g940 (.n_ena(w548_r), .a(w740), .x(d[1]) );
	dmg_notif0 g941 (.n_ena(w548_r), .a(w1240), .x(d[2]) );
	dmg_notif0 g942 (.n_ena(w399), .a(w398), .x(d[2]) );
	dmg_notif0 g943 (.n_ena(w28), .a(w912), .x(d[7]) );
	dmg_notif0 g944 (.n_ena(w28), .a(w326), .x(d[0]) );
	dmg_notif0 g945 (.n_ena(w68), .a(w1005), .x(d[1]) );
	dmg_notif0 g946 (.n_ena(w68), .a(w825), .x(d[2]) );
	dmg_notif0 g947 (.n_ena(w68), .a(w911), .x(d[0]) );
	dmg_notif0 g948 (.n_ena(w993), .a(w967), .x(d[0]) );
	dmg_notif0 g949 (.n_ena(w413), .a(w484), .x(d[6]) );
	dmg_notif0 g950 (.n_ena(w1101), .a(w1100), .x(d[6]) );
	dmg_notif0 g951 (.n_ena(w15), .a(w20), .x(d[4]) );
	dmg_notif0 g952 (.n_ena(w15), .a(w20), .x(d[7]) );
	dmg_notif0 g953 (.n_ena(w812), .a(w1154), .x(d[0]) );
	dmg_notif0 g954 (.n_ena(w812), .a(w813), .x(d[3]) );
	dmg_notif0 g955 (.n_ena(w225), .a(w224), .x(d[6]) );
	...
	dmg_and g993 (.a(d[4]), .b(w90), .x(w1252) );
	...
	dmg_nand4 g1041 (.a(w1204), .b(w1200), .c(a[5]), .d(a[4]), .x(w1201) );
	...
	dmg_mux g1062 (.sel(w397), .d1(w102), .d0(a[1]), .q(w1340) );
	dmg_mux g1063 (.sel(w397), .d1(w105), .d0(a[2]), .q(w1142) );
	dmg_mux g1064 (.sel(w397), .d1(w109), .d0(a[3]), .q(w1143) );
	...
	dmg_mux g1080 (.sel(w397), .d1(w668), .d0(a[0]), .q(w1141) );
	dmg_bufif0 g1081 (.a0(w1146), .n_ena(w125), .a1(w1146), .x(a[2]) );
	dmg_bufif0 g1082 (.a0(w124), .n_ena(w125), .a1(w124), .x(a[4]) );
	dmg_bufif0 g1083 (.a0(w689), .n_ena(w125), .a1(w689), .x(a[3]) );
	dmg_bufif0 g1084 (.a0(w1161), .n_ena(w125), .a1(w1161), .x(a[5]) );
	dmg_bufif0 g1085 (.a0(w87), .n_ena(w125), .a1(w87), .x(a[7]) );
	dmg_bufif0 g1086 (.a0(w989), .n_ena(w125), .a1(w989), .x(a[6]) );
	dmg_bufif0 g1087 (.a0(w699), .n_ena(w125), .a1(w699), .x(a[1]) );
	...
	dmg_bufif0 g1099 (.a0(w443), .n_ena(w125), .a1(w443), .x(a[0]) );
	dmg_not2 g1100 (.a(w395), .x(w396) );
	dmg_latch g1101 (.ena(w5), .d(a[1]), .q(w382) );
	dmg_latch g1102 (.ena(w5), .d(a[5]), .q(w4) );
	dmg_latch g1103 (.ena(w5), .d(a[6]), .q(w577) );
	dmg_latch g1104 (.ena(w5), .d(a[3]), .q(w1124) );
	dmg_latch g1105 (.ena(w5), .d(a[7]), .q(w384) );
	dmg_latch g1106 (.ena(w5), .d(a[4]), .q(w690) );
	dmg_latch g1107 (.ena(w5), .d(a[0]), .q(w6) );
	dmg_latch g1108 (.ena(w5), .d(a[2]), .q(w692) );
	...
	dmg_notif1 g1255 (.ena(w582), .a(w572), .x(d[2]) );
	dmg_notif1 g1256 (.ena(w582), .a(w756), .x(d[7]) );
	dmg_notif1 g1257 (.ena(w582), .a(w757), .x(d[3]) );
	dmg_notif1 g1258 (.ena(w582), .a(w1155), .x(d[4]) );
	dmg_notif1 g1259 (.ena(w582), .a(w1156), .x(d[5]) );
	dmg_notif1 g1260 (.ena(w582), .a(w377), .x(d[1]) );
	dmg_notif1 g1261 (.ena(w582), .a(w513), .x(d[0]) );
	dmg_notif1 g1262 (.ena(w582), .a(w645), .x(d[6]) );
	dmg_not g1263 (.a(w144), .x(w773) );
	dmg_notif0 g1264 (.n_ena(w116), .a(w436), .x(d[1]) );
	dmg_nand5 g1265 (.a(w134), .b(w133), .c(w129), .d(w1061), .e(w834), .x(w833) );
	dmg_nand5 g1266 (.a(w956), .b(a[5]), .c(a[6]), .d(w800), .e(w801), .x(w1199) );
	dmg_nand5 g1267 (.a(w502), .b(w353), .c(w91), .d(w355), .e(w1209), .x(w92) );
	dmg_nand5 g1268 (.a(w439), .b(w440), .c(w156), .d(w541), .e(w471), .x(w470) );
	dmg_not g1269 (.a(d[2]), .x(w547) );
	...
	dmg_or4 g1297 (.a(a[4]), .b(w711), .c(a[6]), .d(a[7]), .x(w1197) );
	dmg_or4 g1298 (.a(w710), .b(a[5]), .c(a[6]), .d(a[7]), .x(w665) );
	...
	dmg_nor6 g1327 (.a(a[7]), .b(a[4]), .c(a[3]), .d(a[2]), .e(a[1]), .f(a[0]), .x(w1342) );
