module PPU1 (  a, d, n_ma, n_lcd_ld1, n_lcd_ld0, n_lcd_cpg, n_lcd_cp, n_lcd_st, n_lcd_cpl, n_lcd_fr, n_lcd_s, CONST0, n_dma_phi, ppu_rd, ppu_wr, ppu_clk, vram_to_oam, ffxx, n_ppu_hard_reset, ff46, 
	...
	dmg_not g60 (.a(nma[11]), .x(w579) );
	dmg_not g61 (.a(w626), .x(w628) );
	dmg_not g62 (.a(w626), .x(w627) );
	dmg_not g63 (.a(nma[12]), .x(w64) );
	dmg_not g64 (.a(w958), .x(w959) );
	dmg_not g65 (.a(nma[10]), .x(w61) );
	...
	dmg_not g196 (.a(nma[3]), .x(w277) );
	dmg_not g197 (.a(nma[2]), .x(w155) );
	dmg_not g198 (.a(w88), .x(w811) );
	dmg_not g199 (.a(nma[6]), .x(w888) );
	dmg_not g200 (.a(nma[5]), .x(w50) );
	dmg_not g201 (.a(w317), .x(w812) );
	dmg_not g202 (.a(w317), .x(w890) );
	dmg_not g203 (.a(w317), .x(w655) );
	dmg_not g204 (.a(nma[0]), .x(w795) );
	dmg_not g205 (.a(nma[4]), .x(w514) );
	dmg_not g206 (.a(nma[7]), .x(w511) );
	dmg_not g207 (.a(nma[1]), .x(w386) );
	...
	dmg_latch_comp g445 (.n_ena(w218), .d(md[3]), .ena(w119), .q(w322) );
	dmg_latch_comp g446 (.n_ena(w218), .d(md[0]), .ena(w119), .q(w329) );
	dmg_latch_comp g447 (.n_ena(w218), .d(md[1]), .ena(w119), .q(w326) );
	dmg_latch_comp g448 (.n_ena(w218), .d(md[6]), .ena(w119), .q(w118) );
	dmg_latch_comp g449 (.n_ena(w218), .d(md[7]), .ena(w119), .q(w213) );
	...
	dmg_latch_comp g466 (.n_ena(w218), .d(md[2]), .ena(w119), .q(w315) );
	dmg_latch_comp g467 (.n_ena(w218), .d(md[4]), .ena(w119), .q(w215) );
	dmg_latch_comp g468 (.n_ena(w218), .d(md[5]), .ena(w119), .q(w660) );
	...
	dmg_notif0 g521 (.n_ena(w95), .a(w431), .x(d[5]) );
	dmg_notif0 g522 (.n_ena(w95), .a(w856), .x(d[0]) );
	dmg_notif0 g523 (.n_ena(w95), .a(w96), .x(d[2]) );
	dmg_notif0 g524 (.n_ena(w95), .a(w797), .x(d[7]) );
	dmg_notif0 g525 (.n_ena(w95), .a(w889), .x(d[6]) );
	dmg_notif0 g526 (.n_ena(w95), .a(w100), .x(d[3]) );
	dmg_notif0 g527 (.n_ena(w95), .a(w94), .x(d[4]) );
	dmg_notif0 g528 (.n_ena(w95), .a(w883), .x(d[1]) );
	dmg_notif0 g529 (.n_ena(w370), .a(w515), .x(d[0]) );
	dmg_notif0 g530 (.n_ena(w370), .a(w885), .x(d[3]) );
	dmg_notif0 g531 (.n_ena(w259), .a(w258), .x(d[2]) );
	dmg_notif0 g532 (.n_ena(w158), .a(w157), .x(d[3]) );
	dmg_notif0 g533 (.n_ena(w450), .a(w101), .x(d[3]) );
	dmg_notif0 g534 (.n_ena(w450), .a(w729), .x(d[4]) );
	dmg_notif0 g535 (.n_ena(w450), .a(w730), .x(d[7]) );
	dmg_notif0 g536 (.n_ena(w450), .a(w488), .x(d[5]) );
	dmg_notif0 g537 (.n_ena(w450), .a(w480), .x(d[6]) );
	dmg_notif0 g538 (.n_ena(w236), .a(w589), .x(nma[11]) );
	dmg_notif0 g539 (.n_ena(w236), .a(w590), .x(nma[9]) );
	dmg_notif0 g540 (.n_ena(w236), .a(w331), .x(nma[8]) );
	dmg_notif0 g541 (.n_ena(w236), .a(w591), .x(nma[10]) );
	dmg_notif0 g542 (.n_ena(w236), .a(w551), .x(nma[12]) );
	dmg_notif0 g543 (.n_ena(w67), .a(w747), .x(d[2]) );
	dmg_notif0 g544 (.n_ena(w67), .a(w746), .x(d[0]) );
	dmg_notif0 g545 (.n_ena(w67), .a(w602), .x(d[3]) );
	dmg_notif0 g546 (.n_ena(w67), .a(w601), .x(d[4]) );
	dmg_notif0 g547 (.n_ena(w450), .a(w107), .x(d[0]) );
	dmg_notif0 g548 (.n_ena(w450), .a(w449), .x(d[2]) );
	dmg_notif0 g549 (.n_ena(w333), .a(w381), .x(nma[2]) );
	dmg_notif0 g550 (.n_ena(w333), .a(w385), .x(nma[1]) );
	dmg_notif0 g551 (.n_ena(w333), .a(w332), .x(nma[3]) );
	dmg_notif0 g552 (.n_ena(w572), .a(w635), .x(nma[4]) );
	dmg_notif0 g553 (.n_ena(w57), .a(w86), .x(d[0]) );
	dmg_notif0 g554 (.n_ena(w57), .a(w53), .x(d[3]) );
	dmg_notif0 g555 (.n_ena(w57), .a(w56), .x(d[2]) );
	dmg_notif0 g556 (.n_ena(w259), .a(w335), .x(d[6]) );
	dmg_notif0 g557 (.n_ena(w259), .a(w78), .x(d[7]) );
	dmg_notif0 g558 (.n_ena(w259), .a(w336), .x(d[3]) );
	dmg_notif0 g559 (.n_ena(w259), .a(w358), .x(d[5]) );
	dmg_notif0 g560 (.n_ena(w259), .a(w283), .x(d[1]) );
	dmg_notif0 g561 (.n_ena(w341), .a(w342), .x(d[0]) );
	dmg_notif0 g562 (.n_ena(w341), .a(w951), .x(d[2]) );
	dmg_notif0 g563 (.n_ena(w341), .a(w357), .x(d[3]) );
	dmg_notif0 g564 (.n_ena(w341), .a(w348), .x(d[7]) );
	dmg_notif0 g565 (.n_ena(w341), .a(w340), .x(d[5]) );
	dmg_notif0 g566 (.n_ena(w341), .a(w824), .x(d[6]) );
	dmg_notif0 g567 (.n_ena(w341), .a(w829), .x(d[4]) );
	dmg_notif0 g568 (.n_ena(w341), .a(w828), .x(d[1]) );
	dmg_notif0 g569 (.n_ena(w57), .a(w973), .x(d[1]) );
	dmg_notif0 g570 (.n_ena(w57), .a(w80), .x(d[7]) );
	dmg_notif0 g571 (.n_ena(w236), .a(w133), .x(nma[5]) );
	dmg_notif0 g572 (.n_ena(w236), .a(w132), .x(nma[2]) );
	dmg_notif0 g573 (.n_ena(w236), .a(w570), .x(nma[4]) );
	dmg_notif0 g574 (.n_ena(w236), .a(w134), .x(nma[7]) );
	dmg_notif0 g575 (.n_ena(w236), .a(w127), .x(nma[6]) );
	dmg_notif0 g576 (.n_ena(w333), .a(w222), .x(nma[0]) );
	dmg_notif0 g577 (.n_ena(w236), .a(w912), .x(nma[0]) );
	dmg_notif0 g578 (.n_ena(w236), .a(w130), .x(nma[1]) );
	dmg_notif0 g579 (.n_ena(w572), .a(w272), .x(nma[0]) );
	dmg_notif0 g580 (.n_ena(w236), .a(w129), .x(nma[3]) );
	dmg_notif0 g581 (.n_ena(w572), .a(w565), .x(nma[1]) );
	dmg_notif0 g582 (.n_ena(w572), .a(w380), .x(nma[2]) );
	dmg_notif0 g583 (.n_ena(w572), .a(w275), .x(nma[3]) );
	dmg_notif0 g584 (.n_ena(w572), .a(w573), .x(nma[9]) );
	dmg_notif0 g585 (.n_ena(w572), .a(w125), .x(nma[8]) );
	dmg_notif0 g586 (.n_ena(w572), .a(w576), .x(nma[7]) );
	dmg_notif0 g587 (.n_ena(w572), .a(w963), .x(nma[6]) );
	dmg_notif0 g588 (.n_ena(w572), .a(w640), .x(nma[5]) );
	dmg_notif0 g589 (.n_ena(w572), .a(w47), .x(nma[11]) );
	dmg_notif0 g590 (.n_ena(w572), .a(w641), .x(nma[10]) );
	dmg_notif0 g591 (.n_ena(w572), .a(w47), .x(nma[12]) );
	dmg_notif0 g592 (.n_ena(w57), .a(w536), .x(d[6]) );
	dmg_notif0 g593 (.n_ena(w57), .a(w87), .x(d[4]) );
	dmg_notif0 g594 (.n_ena(w57), .a(w873), .x(d[5]) );
	dmg_notif0 g595 (.n_ena(w67), .a(w66), .x(d[1]) );
	dmg_notif0 g596 (.n_ena(w259), .a(w967), .x(d[4]) );
	dmg_notif0 g597 (.n_ena(w259), .a(w966), .x(d[0]) );
	dmg_notif0 g598 (.n_ena(w67), .a(w289), .x(d[6]) );
	dmg_notif0 g599 (.n_ena(w67), .a(w748), .x(d[5]) );
	dmg_notif0 g600 (.n_ena(w475), .a(w850), .x(d[5]) );
	dmg_notif0 g601 (.n_ena(w158), .a(w425), .x(d[1]) );
	dmg_notif0 g602 (.n_ena(w67), .a(w427), .x(d[7]) );
	dmg_notif0 g603 (.n_ena(w158), .a(w90), .x(d[2]) );
	dmg_notif0 g604 (.n_ena(w158), .a(w543), .x(d[6]) );
	dmg_notif0 g605 (.n_ena(w158), .a(w508), .x(d[0]) );
	dmg_notif0 g606 (.n_ena(w158), .a(w430), .x(d[5]) );
	dmg_notif0 g607 (.n_ena(w475), .a(w476), .x(d[4]) );
	dmg_notif0 g608 (.n_ena(w475), .a(w544), .x(d[6]) );
	dmg_notif0 g609 (.n_ena(w475), .a(w479), .x(d[3]) );
	dmg_notif0 g610 (.n_ena(w450), .a(w451), .x(d[1]) );
	dmg_notif0 g611 (.n_ena(w158), .a(w490), .x(d[4]) );
	dmg_notif0 g612 (.n_ena(w158), .a(w282), .x(d[7]) );
	dmg_notif0 g613 (.n_ena(w370), .a(w369), .x(d[2]) );
	dmg_notif0 g614 (.n_ena(w370), .a(w884), .x(d[5]) );
	dmg_notif0 g615 (.n_ena(w370), .a(w806), .x(d[7]) );
	dmg_notif0 g616 (.n_ena(w370), .a(w813), .x(d[4]) );
	dmg_notif0 g617 (.n_ena(w370), .a(w371), .x(d[6]) );
	dmg_notif0 g618 (.n_ena(w370), .a(w642), .x(d[1]) );
	dmg_latchnq_comp g619 (.n_ena(w93), .d(d[7]), .ena(w92), .q(w798), .nq(w797) );
	dmg_latchnq_comp g620 (.n_ena(w93), .d(d[5]), .ena(w92), .q(w432), .nq(w431) );
	dmg_latchnq_comp g621 (.n_ena(w93), .d(d[6]), .ena(w92), .q(w388), .nq(w889) );
	dmg_latchnq_comp g622 (.n_ena(w93), .d(d[3]), .ena(w92), .q(w99), .nq(w100) );
	dmg_latchnq_comp g623 (.n_ena(w93), .d(d[4]), .ena(w92), .q(w800), .nq(w94) );
	dmg_latchnq_comp g624 (.n_ena(w93), .d(d[1]), .ena(w92), .q(w882), .nq(w883) );
	dmg_latchnq_comp g625 (.n_ena(w108), .d(d[1]), .ena(w728), .q(w452), .nq(w451) );
	dmg_latchnq_comp g626 (.n_ena(w69), .d(d[1]), .ena(w70), .q(w827), .nq(w828) );
	dmg_latchnq_comp g627 (.n_ena(w69), .d(d[4]), .ena(w70), .q(w830), .nq(w829) );
	dmg_latchnq_comp g628 (.n_ena(w69), .d(d[6]), .ena(w70), .q(w831), .nq(w824) );
	dmg_latchnq_comp g629 (.n_ena(w69), .d(d[5]), .ena(w70), .q(w347), .nq(w340) );
	dmg_latchnq_comp g630 (.n_ena(w69), .d(d[7]), .ena(w70), .q(w349), .nq(w348) );
	dmg_latchnq_comp g631 (.n_ena(w69), .d(d[3]), .ena(w70), .q(w356), .nq(w357) );
	dmg_latchnq_comp g632 (.n_ena(w69), .d(d[2]), .ena(w70), .q(w950), .nq(w951) );
	dmg_latchnq_comp g633 (.n_ena(w69), .d(d[0]), .ena(w70), .q(w343), .nq(w342) );
	dmg_latchr_comp g634 (.n_ena(w88), .d(d[7]), .ena(w811), .nres(w249), .q(w805), .nq(w806) );
	dmg_latchr_comp g635 (.n_ena(w88), .d(d[1]), .ena(w811), .nres(w249), .q(w643), .nq(w642) );
	dmg_latchr_comp g636 (.n_ena(w88), .d(d[2]), .ena(w811), .nres(w249), .q(w368), .nq(w369) );
	dmg_latchr_comp g637 (.n_ena(w293), .d(d[7]), .ena(w410), .nres(w249), .q(w281), .nq(w282) );
	dmg_latchr_comp g638 (.n_ena(w293), .d(d[1]), .ena(w410), .nres(w249), .q(w413), .nq(w425) );
	dmg_latchr_comp g639 (.n_ena(w293), .d(d[2]), .ena(w410), .nres(w249), .q(w89), .nq(w90) );
	dmg_latchr_comp g640 (.n_ena(w293), .d(d[4]), .ena(w410), .nres(w249), .q(w491), .nq(w490) );
	dmg_latchr_comp g641 (.n_ena(w293), .d(d[6]), .ena(w410), .nres(w249), .q(w542), .nq(w543) );
	dmg_latchr_comp g642 (.n_ena(w293), .d(d[5]), .ena(w410), .nres(w249), .q(w541), .nq(w430) );
	dmg_latchr_comp g643 (.n_ena(w293), .d(d[0]), .ena(w410), .nres(w249), .q(w250), .nq(w508) );
	dmg_latchr_comp g644 (.n_ena(w609), .d(d[5]), .ena(w608), .nres(w246), .q(w774), .nq(w850) );
	dmg_latchr_comp g645 (.n_ena(w609), .d(d[4]), .ena(w608), .nres(w246), .q(w477), .nq(w476) );
	dmg_latchr_comp g646 (.n_ena(w609), .d(d[3]), .ena(w608), .nres(w246), .q(w478), .nq(w479) );
	dmg_latchr_comp g647 (.n_ena(w609), .d(d[6]), .ena(w608), .nres(w246), .q(w545), .nq(w544) );
	dmg_latchr_comp g648 (.n_ena(w71), .d(d[7]), .ena(w247), .nres(w246), .q(w607), .nq(w427) );
	dmg_latchr_comp g649 (.n_ena(w85), .d(d[6]), .ena(w535), .nres(w138), .q(w641), .nq(w536) );
	dmg_latchr_comp g650 (.n_ena(w85), .d(d[4]), .ena(w535), .nres(w138), .q(w207), .nq(w87) );
	dmg_latchr_comp g651 (.n_ena(w85), .d(d[5]), .ena(w535), .nres(w138), .q(w538), .nq(w873) );
	dmg_latchr_comp g652 (.n_ena(w83), .d(d[7]), .ena(w84), .nres(w82), .q(w149) );
	dmg_latchr_comp g653 (.n_ena(w85), .d(d[2]), .ena(w535), .nres(w138), .q(w55), .nq(w56) );
	dmg_latchr_comp g654 (.n_ena(w85), .d(d[3]), .ena(w535), .nres(w138), .q(w54), .nq(w53) );
	dmg_latchr_comp g655 (.n_ena(w85), .d(d[1]), .ena(w535), .nres(w138), .q(w822), .nq(w973) );
	dmg_latchr_comp g656 (.n_ena(w85), .d(d[7]), .ena(w535), .nres(w138), .q(w81), .nq(w80) );
	dmg_latchr_comp g657 (.n_ena(w85), .d(d[0]), .ena(w535), .nres(w138), .q(w139), .nq(w86) );
	dmg_latchr_comp g658 (.n_ena(w71), .d(d[1]), .ena(w247), .nres(w246), .q(w849), .nq(w66) );
	dmg_latchr_comp g659 (.n_ena(w71), .d(d[5]), .ena(w247), .nres(w246), .q(w872), .nq(w748) );
	dmg_latchr_comp g660 (.n_ena(w71), .d(d[6]), .ena(w247), .nres(w246), .q(w604), .nq(w289) );
	dmg_latchr_comp g661 (.n_ena(w71), .d(d[4]), .ena(w247), .nres(w246), .q(w600), .nq(w601) );
	dmg_latchr_comp g662 (.n_ena(w71), .d(d[3]), .ena(w247), .nres(w246), .q(w603), .nq(w602) );
	dmg_latchr_comp g663 (.n_ena(w71), .d(d[0]), .ena(w247), .nres(w246), .q(w745), .nq(w746) );
	dmg_latchr_comp g664 (.n_ena(w71), .d(d[2]), .ena(w247), .nres(w246), .q(w245), .nq(w747) );
	dmg_latchr_comp g665 (.n_ena(w293), .d(d[3]), .ena(w410), .nres(w249), .q(w253), .nq(w157) );
	dmg_latchr_comp g666 (.n_ena(w88), .d(d[3]), .ena(w811), .nres(w249), .q(w886), .nq(w885) );
	dmg_latchr_comp g667 (.n_ena(w88), .d(d[5]), .ena(w811), .nres(w249), .q(w957), .nq(w884) );
	dmg_latchr_comp g668 (.n_ena(w88), .d(d[0]), .ena(w811), .nres(w249), .q(w516), .nq(w515) );
	dmg_latchr_comp g669 (.n_ena(w88), .d(d[6]), .ena(w811), .nres(w249), .q(w372), .nq(w371) );
	dmg_latchr_comp g670 (.n_ena(w88), .d(d[4]), .ena(w811), .nres(w249), .q(w807), .nq(w813) );
	dmg_latchnq_comp g671 (.n_ena(w93), .d(d[0]), .ena(w92), .q(w857), .nq(w856) );
	dmg_latchnq_comp g672 (.n_ena(w93), .d(d[2]), .ena(w92), .q(w97), .nq(w96) );
	dmg_latchnq_comp g673 (.n_ena(w108), .d(d[3]), .ena(w728), .q(w102), .nq(w101) );
	dmg_latchnq_comp g674 (.n_ena(w108), .d(d[4]), .ena(w728), .q(w732), .nq(w729) );
	dmg_latchnq_comp g675 (.n_ena(w108), .d(d[7]), .ena(w728), .q(w731), .nq(w730) );
	dmg_latchnq_comp g676 (.n_ena(w108), .d(d[5]), .ena(w728), .q(w487), .nq(w488) );
	dmg_latchnq_comp g677 (.n_ena(w108), .d(d[6]), .ena(w728), .q(w481), .nq(w480) );
	dmg_latchnq_comp g678 (.n_ena(w108), .d(d[2]), .ena(w728), .q(w486), .nq(w449) );
	dmg_latchnq_comp g679 (.n_ena(w108), .d(d[0]), .ena(w728), .q(w106), .nq(w107) );
	...
	dmg_notif1 g854 (.ena(w232), .a(w231), .x(d[0]) );
	dmg_notif1 g855 (.ena(w209), .a(w558), .x(nma[11]) );
	dmg_notif1 g856 (.ena(w209), .a(w46), .x(nma[9]) );
	dmg_notif1 g857 (.ena(w209), .a(w765), .x(nma[7]) );
	dmg_notif1 g858 (.ena(w209), .a(w851), .x(nma[8]) );
	dmg_notif1 g859 (.ena(w232), .a(w773), .x(d[2]) );
	dmg_notif1 g860 (.ena(w209), .a(w762), .x(nma[5]) );
	dmg_notif1 g861 (.ena(w209), .a(w761), .x(nma[10]) );
	dmg_notif1 g862 (.ena(w209), .a(w561), .x(nma[6]) );
	dmg_notif1 g863 (.ena(w209), .a(w592), .x(nma[4]) );
	dmg_notif1 g864 (.ena(w209), .a(w208), .x(nma[12]) );
	dmg_notif1 g865 (.ena(w232), .a(w238), .x(d[1]) );
	...
	dmg_dffr_comp g882 (.nr1(w47), .nr2(w47), .d(md[5]), .ck(w311), .cck(w312), .q(w46) );
	dmg_dffr_comp g883 (.nr1(w47), .nr2(w47), .d(md[2]), .ck(w311), .cck(w312), .q(w561) );
	dmg_dffr_comp g884 (.nr1(w47), .nr2(w47), .d(md[7]), .ck(w311), .cck(w312), .q(w558) );
	dmg_dffr_comp g885 (.nr1(w47), .nr2(w47), .d(md[6]), .ck(w311), .cck(w312), .q(w761) );
	dmg_dffr_comp g886 (.nr1(w47), .nr2(w47), .d(md[3]), .ck(w311), .cck(w312), .q(w765) );
	dmg_dffr_comp g887 (.nr1(w47), .nr2(w47), .d(md[4]), .ck(w311), .cck(w312), .q(w851) );
	dmg_dffr_comp g888 (.nr1(w47), .nr2(w47), .d(md[1]), .ck(w311), .cck(w312), .q(w762) );
	dmg_dffr_comp g889 (.nr1(w47), .nr2(w47), .d(md[0]), .ck(w311), .cck(w312), .q(w592) );
	dmg_mux g890 (.sel(w122), .d1(md[0]), .d0(md[7]), .q(w308) );
	dmg_mux g891 (.sel(w122), .d1(md[7]), .d0(md[0]), .q(w879) );
	dmg_mux g892 (.sel(w122), .d1(md[6]), .d0(md[1]), .q(w766) );
	dmg_mux g893 (.sel(w122), .d1(md[1]), .d0(md[6]), .q(w447) );
	dmg_mux g894 (.sel(w122), .d1(md[5]), .d0(md[2]), .q(w456) );
	dmg_mux g895 (.sel(w122), .d1(md[2]), .d0(md[5]), .q(w866) );
	dmg_mux g896 (.sel(w122), .d1(md[3]), .d0(md[4]), .q(w485) );
	dmg_mux g897 (.sel(w122), .d1(md[4]), .d0(md[3]), .q(w445) );
