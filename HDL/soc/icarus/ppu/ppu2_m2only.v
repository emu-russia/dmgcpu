module PPU2 (  cclk, clk6, n_reset2, a, d, n_oamb, oam_bl_pch, oa, n_oam_rd, n_oamb_wr, n_oama_wr, n_oama, CONST0, n_dma_phi,
	...
	dmg_notif0 g292 (.n_ena(w170), .a(w171), .x(nma[0]) );
	dmg_notif0 g293 (.n_ena(w153), .a(w914), .x(nma[0]) );
	dmg_notif0 g294 (.n_ena(w183), .a(w108), .x(nma[10]) );
	dmg_notif0 g295 (.n_ena(w170), .a(w911), .x(nma[3]) );
	dmg_notif0 g296 (.n_ena(w62), .a(md[7]), .x(n_oamb[7]) );
	dmg_notif0 g297 (.n_ena(w62), .a(md[2]), .x(n_oamb[2]) );
	dmg_notif0 g298 (.n_ena(w62), .a(md[1]), .x(n_oamb[1]) );
	dmg_notif0 g299 (.n_ena(w62), .a(md[4]), .x(n_oamb[4]) );
	dmg_notif0 g300 (.n_ena(w62), .a(md[7]), .x(n_oama[7]) );
	dmg_notif0 g301 (.n_ena(w62), .a(md[4]), .x(n_oama[4]) );
	dmg_notif0 g302 (.n_ena(w62), .a(md[1]), .x(n_oama[1]) );
	dmg_notif0 g303 (.n_ena(w62), .a(md[2]), .x(n_oama[2]) );
	dmg_notif0 g304 (.n_ena(w183), .a(w698), .x(nma[0]) );
	dmg_notif0 g305 (.n_ena(w183), .a(w814), .x(nma[2]) );
	dmg_notif0 g306 (.n_ena(w183), .a(w448), .x(nma[1]) );
	dmg_notif0 g307 (.n_ena(w183), .a(w533), .x(nma[4]) );
	dmg_notif0 g308 (.n_ena(w62), .a(md[5]), .x(n_oamb[5]) );
	dmg_notif0 g309 (.n_ena(w62), .a(md[5]), .x(n_oama[5]) );
	dmg_notif0 g310 (.n_ena(w140), .a(w562), .x(n_oama[3]) );
	dmg_notif0 g311 (.n_ena(w140), .a(w562), .x(n_oamb[3]) );
	dmg_notif0 g312 (.n_ena(w203), .a(w442), .x(d[5]) );
	dmg_notif0 g313 (.n_ena(w203), .a(w186), .x(d[4]) );
	dmg_notif0 g314 (.n_ena(w203), .a(w890), .x(d[7]) );
	dmg_notif0 g315 (.n_ena(w203), .a(w401), .x(d[2]) );
	dmg_notif0 g316 (.n_ena(w145), .a(w469), .x(d[4]) );
	dmg_notif0 g317 (.n_ena(w183), .a(w524), .x(nma[7]) );
	dmg_notif0 g318 (.n_ena(w183), .a(w180), .x(nma[8]) );
	dmg_notif0 g319 (.n_ena(w183), .a(w468), .x(nma[6]) );
	dmg_notif0 g320 (.n_ena(w183), .a(w812), .x(nma[3]) );
	dmg_notif0 g321 (.n_ena(w183), .a(w149), .x(nma[12]) );
	dmg_notif0 g322 (.n_ena(w183), .a(w149), .x(nma[11]) );
	dmg_notif0 g323 (.n_ena(w62), .a(md[3]), .x(n_oama[3]) );
	dmg_notif0 g324 (.n_ena(w62), .a(md[6]), .x(n_oama[6]) );
	dmg_notif0 g325 (.n_ena(w62), .a(md[3]), .x(n_oamb[3]) );
	...
	dmg_notif0 g344 (.n_ena(w153), .a(w808), .x(nma[1]) );
	dmg_notif0 g345 (.n_ena(w137), .a(w703), .x(nma[0]) );
	dmg_notif0 g346 (.n_ena(w137), .a(w132), .x(nma[6]) );
	dmg_notif0 g347 (.n_ena(w137), .a(w233), .x(nma[1]) );
	dmg_notif0 g348 (.n_ena(w203), .a(w864), .x(d[0]) );
	dmg_notif0 g349 (.n_ena(w203), .a(w157), .x(d[1]) );
	dmg_notif0 g350 (.n_ena(w137), .a(w645), .x(nma[10]) );
	dmg_notif0 g351 (.n_ena(w137), .a(w116), .x(nma[7]) );
	dmg_notif0_od g352 (.n_ena((w403 | w3)), .a(w404), .x(w641) );
	dmg_notif0_od g353 (.n_ena((w403 | w3)), .a(w50), .x(w49) );
	dmg_notif0 g354 (.n_ena(w137), .a(w136), .x(nma[8]) );
	dmg_notif0 g355 (.n_ena(w137), .a(w135), .x(nma[12]) );
	dmg_notif0_od g356 (.n_ena((w48 | w3)), .a(w643), .x(w641) );
	dmg_notif0_od g357 (.n_ena((w48 | w3)), .a(w553), .x(w500) );
	dmg_notif0 g358 (.n_ena(w48), .a(w499), .x(w464) );
	dmg_notif0 g359 (.n_ena(w518), .a(w69), .x(w464) );
	dmg_notif0_od g360 (.n_ena(w518), .a(w516), .x(w146) );
	dmg_notif0 g361 (.n_ena(w475), .a(w149), .x(w863) );
	dmg_notif0_od g362 (.n_ena((w475 | w3)), .a(w284), .x(w146) );
	dmg_notif0 g363 (.n_ena(w145), .a(w528), .x(d[6]) );
	dmg_notif0 g364 (.n_ena(w145), .a(w520), .x(d[7]) );
	dmg_notif0 g365 (.n_ena(w145), .a(w537), .x(d[3]) );
	dmg_notif0 g366 (.n_ena(w145), .a(w536), .x(d[5]) );
	dmg_notif0 g367 (.n_ena(w145), .a(w441), .x(d[2]) );
	dmg_notif0_od g368 (.n_ena(w518), .a(w517), .x(w500) );
	dmg_notif0 g369 (.n_ena(w145), .a(w646), .x(d[1]) );
	dmg_notif0_od g370 (.n_ena((w475 | w3)), .a(w487), .x(w500) );
	dmg_notif0_od g371 (.n_ena(w518), .a(w708), .x(w554) );
	dmg_notif0 g372 (.n_ena(w170), .a(w445), .x(nma[10]) );
	dmg_notif0 g373 (.n_ena(w518), .a(w709), .x(w47) );
	dmg_notif0 g374 (.n_ena(w170), .a(w315), .x(nma[9]) );
	...
	dmg_notif0 g379 (.n_ena(w170), .a(w395), .x(nma[11]) );
	dmg_notif0 g380 (.n_ena(w123), .a(d[6]), .x(n_oamb[6]) );
	dmg_notif0 g381 (.n_ena(w123), .a(d[5]), .x(n_oamb[5]) );
	dmg_notif0 g382 (.n_ena(w123), .a(d[3]), .x(n_oama[3]) );
	dmg_notif0 g383 (.n_ena(w123), .a(d[5]), .x(n_oama[5]) );
	dmg_notif0 g384 (.n_ena(w123), .a(d[3]), .x(n_oamb[3]) );
	dmg_notif0 g385 (.n_ena(w123), .a(d[4]), .x(n_oamb[4]) );
	dmg_notif0 g386 (.n_ena(w123), .a(d[0]), .x(n_oama[0]) );
	dmg_notif0 g387 (.n_ena(w123), .a(d[0]), .x(n_oamb[0]) );
	dmg_notif0 g388 (.n_ena(w123), .a(d[4]), .x(n_oama[4]) );
	dmg_notif0 g389 (.n_ena(w123), .a(d[1]), .x(n_oama[1]) );
	dmg_notif0 g390 (.n_ena(w123), .a(d[7]), .x(n_oama[7]) );
	dmg_notif0 g391 (.n_ena(w123), .a(d[7]), .x(n_oamb[7]) );
	dmg_notif0 g392 (.n_ena(w123), .a(d[1]), .x(n_oamb[1]) );
	...
	dmg_notif0 g415 (.n_ena(w123), .a(d[6]), .x(n_oama[6]) );
	dmg_notif0_od g416 (.n_ena((w48 | w3)), .a(w498), .x(w497) );
	dmg_notif0 g417 (.n_ena(w48), .a(w46), .x(w47) );
	dmg_notif0_od g418 (.n_ena((w48 | w3)), .a(w904), .x(w146) );
	dmg_notif0_od g419 (.n_ena(w518), .a(w69), .x(w497) );
	dmg_notif0 g420 (.n_ena(w203), .a(w232), .x(d[3]) );
	dmg_notif0_od g421 (.n_ena((w475 | w3)), .a(w149), .x(w497) );
	dmg_notif0 g422 (.n_ena(w140), .a(w139), .x(n_oama[0]) );
	dmg_notif0 g423 (.n_ena(w140), .a(w139), .x(n_oamb[0]) );
	dmg_notif0 g424 (.n_ena(w145), .a(w638), .x(d[0]) );
	dmg_notif0 g425 (.n_ena(w123), .a(d[2]), .x(n_oama[2]) );
	dmg_notif0 g426 (.n_ena(w123), .a(d[2]), .x(n_oamb[2]) );
	...
	dmg_notif0 g432 (.n_ena(w62), .a(md[0]), .x(n_oama[0]) );
	dmg_notif0 g433 (.n_ena(w170), .a(w119), .x(nma[8]) );
	dmg_notif0 g434 (.n_ena(w62), .a(md[0]), .x(n_oamb[0]) );
	dmg_notif0 g435 (.n_ena(w170), .a(w110), .x(nma[7]) );
	...
	dmg_notif0 g457 (.n_ena(w170), .a(w695), .x(nma[4]) );
	dmg_notif0 g458 (.n_ena(w170), .a(w313), .x(nma[5]) );
	dmg_notif0_od g459 (.n_ena((w444 | w3)), .a(w323), .x(w554) );
	dmg_notif0 g460 (.n_ena(w444), .a(w279), .x(w47) );
	dmg_notif0_od g461 (.n_ena((w444 | w3)), .a(w213), .x(w49) );
	dmg_notif0_od g462 (.n_ena((w444 | w3)), .a(w347), .x(w641) );
	dmg_notif0_od g463 (.n_ena(w518), .a(w640), .x(w641) );
	dmg_notif0_od g464 (.n_ena(w518), .a(w494), .x(w49) );
	dmg_notif0 g465 (.n_ena(w137), .a(w51), .x(nma[11]) );
	dmg_notif0 g466 (.n_ena(w137), .a(w644), .x(nma[2]) );
	dmg_notif0 g467 (.n_ena(w137), .a(w451), .x(nma[3]) );
	dmg_notif0_od g468 (.n_ena((w403 | w3)), .a(w233), .x(w497) );
	dmg_notif0 g469 (.n_ena(w403), .a(w703), .x(w863) );
	dmg_notif0 g470 (.n_ena(w403), .a(w132), .x(w47) );
	dmg_notif0_od g471 (.n_ena((w403 | w3)), .a(w644), .x(w500) );
	dmg_notif0_od g472 (.n_ena((w403 | w3)), .a(w451), .x(w146) );
	dmg_notif0_od g473 (.n_ena((w403 | w3)), .a(w116), .x(w554) );
	dmg_notif0_od g474 (.n_ena((w48 | w3)), .a(w642), .x(w554) );
	dmg_notif0_od g475 (.n_ena((w48 | w3)), .a(w131), .x(w49) );
	dmg_notif0 g476 (.n_ena(w137), .a(w552), .x(nma[9]) );
	dmg_notif0 g477 (.n_ena(w137), .a(w50), .x(nma[4]) );
	dmg_notif0 g478 (.n_ena(w137), .a(w404), .x(nma[5]) );
	dmg_notif0 g479 (.n_ena(w203), .a(w202), .x(d[6]) );
	dmg_notif0 g480 (.n_ena(w183), .a(w182), .x(nma[9]) );
	dmg_notif0 g481 (.n_ena(w183), .a(w467), .x(nma[5]) );
	dmg_notif0 g482 (.n_ena(w153), .a(w150), .x(nma[3]) );
	dmg_notif0 g483 (.n_ena(w170), .a(w69), .x(nma[12]) );
	dmg_notif0 g484 (.n_ena(w153), .a(w152), .x(nma[2]) );
	...
	dmg_notif0 g511 (.n_ena(w170), .a(w319), .x(nma[1]) );
	dmg_notif0 g512 (.n_ena(w62), .a(md[6]), .x(n_oamb[6]) );
	dmg_notif0 g513 (.n_ena(w140), .a(w527), .x(n_oamb[1]) );
	dmg_notif0 g514 (.n_ena(w140), .a(w901), .x(n_oamb[7]) );
	dmg_notif0 g515 (.n_ena(w140), .a(w901), .x(n_oama[7]) );
	dmg_notif0 g516 (.n_ena(w140), .a(w527), .x(n_oama[1]) );
	dmg_notif0 g517 (.n_ena(w140), .a(w526), .x(n_oamb[2]) );
	dmg_notif0 g518 (.n_ena(w140), .a(w526), .x(n_oama[2]) );
	dmg_notif0 g519 (.n_ena(w140), .a(w534), .x(n_oama[4]) );
	dmg_notif0 g520 (.n_ena(w140), .a(w534), .x(n_oamb[4]) );
	dmg_notif0 g521 (.n_ena(w140), .a(w558), .x(n_oama[6]) );
	dmg_notif0 g522 (.n_ena(w140), .a(w558), .x(n_oamb[6]) );
	dmg_notif0 g523 (.n_ena(w140), .a(w561), .x(n_oama[5]) );
	dmg_notif0 g524 (.n_ena(w140), .a(w561), .x(n_oamb[5]) );
	...
	dmg_notif0 g572 (.n_ena(w170), .a(w910), .x(nma[2]) );
	...
	dmg_latchr_comp g639 (.n_ena(w443), .d(d[2]), .ena(w159), .nres(w11), .q(w400), .nq(w401) );
	dmg_latchr_comp g640 (.n_ena(w443), .d(d[6]), .ena(w159), .nres(w11), .q(w201), .nq(w202) );
	dmg_latchr_comp g641 (.n_ena(w443), .d(d[5]), .ena(w159), .nres(w11), .q(w8), .nq(w442) );
	...
	dmg_latchr_comp g657 (.n_ena(w184), .d(d[0]), .ena(w10), .nres(w11), .q(w639), .nq(w638) );
	dmg_latchr_comp g658 (.n_ena(w443), .d(d[3]), .ena(w159), .nres(w11), .q(w231), .nq(w232) );
	...
	dmg_latchr_comp g699 (.n_ena(w184), .d(d[6]), .ena(w10), .nres(w11), .q(w522), .nq(w528) );
	dmg_latchr_comp g700 (.n_ena(w184), .d(d[7]), .ena(w10), .nres(w11), .q(w519), .nq(w520) );
	dmg_latchr_comp g701 (.n_ena(w184), .d(d[3]), .ena(w10), .nres(w11), .q(w538), .nq(w537) );
	dmg_latchr_comp g702 (.n_ena(w184), .d(d[5]), .ena(w10), .nres(w11), .q(w535), .nq(w536) );
	dmg_latchr_comp g703 (.n_ena(w184), .d(d[2]), .ena(w10), .nres(w11), .q(w805), .nq(w441) );
	dmg_latchr_comp g704 (.n_ena(w184), .d(d[1]), .ena(w10), .nres(w11), .q(w440), .nq(w646) );
	...
	dmg_latchr_comp g726 (.n_ena(w184), .d(d[4]), .ena(w10), .nres(w11), .q(w470), .nq(w469) );
	dmg_latchr_comp g727 (.n_ena(w443), .d(d[0]), .ena(w159), .nres(w11), .q(w422), .nq(w864) );
	dmg_latchr_comp g728 (.n_ena(w443), .d(d[1]), .ena(w159), .nres(w11), .q(w156), .nq(w157) );
	dmg_latchr_comp g729 (.n_ena(w443), .d(d[4]), .ena(w159), .nres(w11), .q(w187), .nq(w186) );
	dmg_latchr_comp g730 (.n_ena(w443), .d(d[7]), .ena(w159), .nres(w11), .q(w103), .nq(w890) );
	dmg_notif0 g731 (.n_ena(w170), .a(w396), .x(nma[6]) );
	dmg_not g732 (.a(w218), .x(w269) );
	dmg_latch g733 (.ena(w165), .d(n_oama[5]), .q(w175), .nq(w176) );
	dmg_latch g734 (.ena(w165), .d(n_oama[7]), .q(w905), .nq(w496) );
	dmg_latch g735 (.ena(w165), .d(n_oamb[5]), .q(w241), .nq(w238) );
	dmg_latch g736 (.ena(w165), .d(n_oama[0]), .q(w505), .nq(w504) );
	dmg_latch g737 (.ena(w165), .d(n_oamb[7]), .q(w705), .nq(w704) );
	dmg_latch g738 (.ena(w165), .d(n_oama[6]), .q(w14), .nq(w13) );
	dmg_latch g739 (.ena(w165), .d(n_oamb[2]), .q(w121), .nq(w122) );
	dmg_latch g740 (.ena(w165), .d(n_oamb[4]), .q(w566), .nq(w565) );
	dmg_latch g741 (.ena(w165), .d(n_oama[1]), .q(w501), .nq(w706) );
	dmg_latch g742 (.ena(w165), .d(n_oamb[1]), .q(w461), .nq(w462) );
	dmg_latch g743 (.ena(w165), .d(n_oamb[0]), .q(w236), .nq(w235) );
	dmg_latch g744 (.ena(w165), .d(n_oama[2]), .q(w502), .nq(w503) );
	dmg_latch g745 (.ena(w165), .d(n_oamb[6]), .q(w240), .nq(w239) );
	dmg_latch g746 (.ena(w165), .d(n_oama[3]), .q(w506), .nq(w507) );
	dmg_latch g747 (.ena(w165), .d(n_oamb[3]), .q(w111), .nq(w112) );
	dmg_latch g748 (.ena(w165), .d(n_oama[4]), .q(w420), .nq(w421) );
	dmg_bufif0 g749 (.a0(w112), .n_ena(w113), .a1(w112), .x(d[3]) );
	dmg_bufif0 g750 (.a0(w239), .n_ena(w113), .a1(w239), .x(d[6]) );
	dmg_bufif0 g751 (.a0(w462), .n_ena(w113), .a1(w462), .x(d[1]) );
	dmg_bufif0 g752 (.a0(w507), .n_ena(w177), .a1(w507), .x(d[3]) );
	dmg_bufif0 g753 (.a0(w421), .n_ena(w177), .a1(w421), .x(d[4]) );
	dmg_bufif0 g754 (.a0(w503), .n_ena(w177), .a1(w503), .x(d[2]) );
	dmg_bufif0 g755 (.a0(w504), .n_ena(w177), .a1(w504), .x(d[0]) );
	dmg_bufif0 g756 (.a0(w706), .n_ena(w177), .a1(w706), .x(d[1]) );
	dmg_bufif0 g757 (.a0(w13), .n_ena(w177), .a1(w13), .x(d[6]) );
	dmg_bufif0 g758 (.a0(w565), .n_ena(w113), .a1(w565), .x(d[4]) );
	dmg_bufif0 g759 (.a0(w704), .n_ena(w113), .a1(w704), .x(d[7]) );
	dmg_bufif0 g760 (.a0(w238), .n_ena(w113), .a1(w238), .x(d[5]) );
	dmg_bufif0 g761 (.a0(w122), .n_ena(w113), .a1(w122), .x(d[2]) );
	dmg_bufif0 g762 (.a0(w235), .n_ena(w113), .a1(w235), .x(d[0]) );
	dmg_bufif0 g763 (.a0(w496), .n_ena(w177), .a1(w496), .x(d[7]) );
	dmg_bufif0 g764 (.a0(w176), .n_ena(w177), .a1(w176), .x(d[5]) );
