...
`define wr w[6]
// 7 skipped
`define op_jr_any_sx01 w[8]
`define op_sp_e_sx10 w[9]
`define alu_res w[10]
`define addr_valid w[11]
`define cb_bit w[12]
`define op_ld_abs_rr_sx00 w[13]
`define op_ldh_any_a_data_cycle w[14]
`define op_add_hl_sxx0 w[15]
`define op_incdec_rr w[16]
`define op_ldh_imm_sx01 w[17]
