...
|d3|{0,2,5,6}<br/>{0,2,5,7,15,17,18}| |All ALU opcodes in range 0x80-0xbf + ALU opcodes 0xc6/0xce, 0xd6/0xde, 0xe6/0xee, 0xf6/0xfe|
...
|d34|{0,2,4,6,15,17,19,20}|Decoder3 (also)| |
|d35|{0,2,4,6,13,14,16,19,24}| | |
|d36|{0,2,4,6,13,14,17,19,22,24}| | |
|d37|{0,2,4,6,12,14,17,19,22,24}| | |
|d38|{0,2,5,7,12,15,16,19,22,25}|Decoder3 (also)| |
|d39|{0,2,5,7,12,15,16,19,22,24}| | |
|d40|{0,2,4,7,8,19,20}<br/>{0,2,4,7,8,16,20}<br/>{0,2,4,7,8,14,20}<br/>{0,2,4,7,10,19,20}<br/>{0,2,4,7,10,16,20}<br/>{0,2,4,7,10,14,20}<br/>{0,2,4,7,13,19,20}<br/>{0,2,4,7,13,16,20}<br/>{0,2,4,7,13,14,20}| | |
|d41|{0,2,4,7}|Decoder3 (not used in Decoder2)|All LD reg/(HL), (HL)/reg, including HALT (in range 0x40-0x7f)|
|d42|{0,3,4,6}|Decoder3, ALU, Bottom (not used in Decoder2)| |
